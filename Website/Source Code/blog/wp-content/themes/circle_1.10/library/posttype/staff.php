...
function kopa_staff_init() {
    $labels = array(
        'name' => __('Staffs', kopa_get_domain()),
        'singular_name' => __('Staff', kopa_get_domain()),
        ...
        'parent_item_colon' => '',
        'menu_name' => __('Staffs', kopa_get_domain())
    );
    ...
    $taxonomy_category_args = array(
        ...
        'hierarchical' => true,
        'labels' => array(
            'name' => __('Staff Categories', 'taxonomy general name', kopa_get_domain()),
            ...
            'edit_item' => __('Edit Staff', kopa_get_domain()),
            'update_item' => __('Update Staff', kopa_get_domain()),
            'add_new_item' => __('Add New Staff', kopa_get_domain()),
            'new_item_name' => __('New Staff Name', kopa_get_domain()),
            ...
            'menu_name' => __('Staff Categories', kopa_get_domain())
        ),
        'show_ui' => true,
    ...
    $taxonomy_tag_args = array(
        ...
        'hierarchical' => false,
        'labels' => array(
            'name' => __('Staff Tags', 'taxonomy general name', kopa_get_domain()),
            ...
            'menu_name' => __('Staff Tags', kopa_get_domain())
        ),
        'show_ui' => true,
        'show_admin_column' => true,
        'update_count_callback' => '',
