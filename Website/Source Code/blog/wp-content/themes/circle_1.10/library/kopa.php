...
function kopa_admin_menu() {
    add_menu_page(
            __('Theme Options', kopa_get_domain()), constant('KOPA_THEME_NAME'), 'edit_themes', 'kopa_cpanel_theme_options', '', trailingslashit(get_stylesheet_directory_uri()) . '/library/images/logo.png', 61
    );
...
function kopa_cpanel_theme_options() {
    include trailingslashit(get_stylesheet_directory()) . '/library/includes/cpanel/theme-options.php';
}

function kopa_cpanel_sidebar_management() {
    include trailingslashit(get_stylesheet_directory()) . '/library/includes/cpanel/sidebar-manager.php';
}

function kopa_cpanel_layout_management() {
    include trailingslashit(get_stylesheet_directory()) . '/library/includes/cpanel/layout-manager.php';
}
...
function kopa_i18n() {
    load_theme_textdomain(kopa_get_domain(), get_stylesheet_directory() . '/languages');
}
