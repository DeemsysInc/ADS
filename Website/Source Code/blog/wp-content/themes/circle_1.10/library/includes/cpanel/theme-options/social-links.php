<div id="tab-social-links" class="kopa-content-box tab-content tab-content-1">    
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            <span class="kopa-component-title"><?php _e('Deviantart URL', kopa_get_domain()); ?></span>
            <input type="url" value="<?php echo get_option('kopa_theme_options_social_links_deviantart_url'); ?>" id="kopa_theme_options_social_links_deviantart_url" name="kopa_theme_options_social_links_deviantart_url">
        </div>        
        <div class="kopa-element-box kopa-theme-options">
            <span class="kopa-component-title"><?php _e('Wordpress URL', kopa_get_domain()); ?></span>
            <input type="url" value="<?php echo get_option('kopa_theme_options_social_links_wordpress_url'); ?>" id="kopa_theme_options_social_links_wordpress_url" name="kopa_theme_options_social_links_wordpress_url">
        </div>
        <div class="kopa-element-box kopa-theme-options">
