                ...
                <div id="isotop-container">
                    ...
                    <div id="pf-items">
                        ...
                        while (have_posts()) : the_post();
                            ...
                            ?>
                            <article class="element clearfix <?php echo $classes; ?>" data-category="<?php echo $classes; ?>">
                                ...
                                <div class="pf-des-1col">
                                    <header>
                                        ...
                                        <span class="entry-author"><span class="icon-user entry-icon"></span><a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author_meta('nicename'); ?></a></span>
                                    </header>
                                    <?php the_excerpt(); ?>
                                    <ul>
