...
<title>Thats not Camping</title>
<?php require('../config.php');
global $config;
?>
<link rel="stylesheet" type="text/css" href="<?php echo $config['LIVE_URL']?>views/css/style.css" />
<script type="text/javascript" src="<?php echo $config['LIVE_URL']?>views/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo $config['LIVE_URL']?>views/js/ddaccordion.js"></script>
...
<script src="<?php echo $config['LIVE_URL']?>views/js/jquery.jclock-1.2.0.js.txt" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo $config['LIVE_URL']?>views/js/jconfirmaction.jquery.js"></script>
<script type="text/javascript">
...
<script language="javascript" type="text/javascript" src="<?php echo $config['LIVE_URL']?>views/js/niceforms.js"></script>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo $config['LIVE_URL']?>views/css/niceforms-default.css" />
...
<div id="main_container">
    ...
    <div class="left_content">
            ...
            <input type="image" class="search_submit" src="<?php echo $config['LIVE_URL']?>views/images/search.png" />
            </form>            
            </div>
            ...
            <div class="sidebar_box">
                ...
                <img src="<?php echo $config['LIVE_URL']?>views/images/info.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div class="sidebar_box">
                ...
                <img src="<?php echo $config['LIVE_URL']?>views/images/notice.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    	<tr>
            ...
            <td><a href="#"><img src="<?php echo $config['LIVE_URL']?>views/images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="#" class="ask"><img src="<?php echo $config['LIVE_URL']?>views/images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
    ...
    <div class="footer">
    	...
    	<div class="left_footer">Copyright &copy; 2011 Thats Not, LLC All Rights Reserved</div>
