...
class cAnalytics{
	...
	public function modShowActiveUsersOverView(){
		try{	
			...
			//get client ids belongs to client user
			$cid=isset($outArrClientUsers[0]['client_ids']) ? $outArrClientUsers[0]['client_ids'] : '';
			//get client info from client ids
			$outArrGetClientInfo = array();
			$outArrGetClientInfo = $this->objClients->getClientById($cid);
			//print_r($outArrGetClientInfo);
    ...
    public function modShowAnalyticsProductsList($sendArray){
		try{	
			global $config;

			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/byproducts';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/list';
			// Parameters for call
			$params = array();
			$params['start_date']=$sendArray['start_date'];
			$params['end_date']=$sendArray['end_date'];
			$params['client_id']=$sendArray['client_id'];
			$params['campaign_id']=$sendArray['campaign_id'];
			...
			curl_close($curl);
                        ...
                        /*$clientInfo=array();
			$clientInfo['client_id']="814";
			$clientInfo['client_name']="Adore";
			*/

			//print_r($arrData);
			
			include SRV_ROOT.'views/analytics/products_views_list.tpl.php';
	  ...
	  public function modShowMobileUseTrackDataByProductsShares($client_id,$start_date,$end_date,$campaign_id,$searchByValOrPercent){
		try{	
			global $config;

			$cid = isset($_SESSION['clientIds']) ? $_SESSION['clientIds'] : 0;
			$search_campaign_id=isset($_REQUEST['campaignIds']) ? $_REQUEST['campaignIds'] : 0;
			// $start_date=isset($_REQUEST['from']) ? $_REQUEST['from'] : date('Y-m-d',strtotime('1 month ago'));
			// $end_date=isset($_REQUEST['to']) ? $_REQUEST['to'] :date('Y-m-d');
			 $groupId = isset($_SESSION['user_group']) ? $_SESSION['user_group'] : 0;
			...
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/byproductshares';
			// Tool name
			//$toolName = 'iprscan';
			...
			include SRV_ROOT.'views/analytics/user_tracking_data_by_products_shares.tpl.php';
    ...
    public function modShowMobileUseTrackDataByOffers($client_id,$campaign_id,$start_date,$end_date){
		try{	
			global $config;
	 ...
	 public function modShowMobileUseTrackDataByOfferShares($client_id,$campaign_id,$start_date,$end_date){
		try{	
			global $config;
			...
			$groupId = isset($_SESSION['user_group']) ? $_SESSION['user_group'] : 0;
           	$search_campaign_id=isset($_REQUEST['campaignIds']) ? $_REQUEST['campaignIds'] : 0;
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/byofferShares';
			// Tool name
			//$toolName = 'iprscan';
			...
			// Close the cURL session
			curl_close($curl);
			 include SRV_ROOT.'views/analytics/user_tracking_data_by_offers_shares.tpl.php';
		}
		catch ( Exception $e ) {
			echo 'Message: ' .$e->getMessage();
		}
...
*/
	...
	function modShowAnalyticsProductsDetails($sendArray)
	{
		try
		{
			global $config;
			...
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/details/'; 
			// Parameters for call
			$params = array();
			$params['start_date']=$sendArray['start_date'];
			$params['end_date']=$sendArray['end_date'];
			$params['product_id']=$sendArray['product_id'];
			$params['client_id']=$sendArray['client_id'];
            ...
            include SRV_ROOT.'views/analytics/product_views_details.tpl.php';
...
$outArrCidValue=explode("=", $outCidVals);
	...
	function modShowProductFlowUserLevel()
	{
		try
		{
			...
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/flow/products/users';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/details/flow/users';
	...
	function modShowGetClientCampaign()
	{
		try
		{
			global $config;
			$client_id=isset($_REQUEST['clientId']) ? $_REQUEST['clientId'] : 0;
			$groupId = isset($_SESSION['user_group']) ? $_SESSION['user_group'] : 0;
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/campaigns/clients';
			// Tool name
			//$toolName = 'iprscan';
			...
			$params['start_date']=$start_date;
			$params['end_date']=$end_date;
			$params['search_client_id']=$clientSearch;
		    ...
		    $arrData=json_decode($jobId,true);
			//print_r($arrData);
			//$_SESSION['start_date']=$arrData[0]['campaign_start_date'];
			//$_SESSION['end_date']=$arrData[0]['campaign_end_date'];
			$_SESSION['search_client_id']=$client_id;
			//$_SESSION['search_campaign_id']=$arrData[0]['campaign_id'];
			//print_r($_SESSION);
	...
	function modShowGetCampaignInfo()
	 {
		try
		{
			global $config;
			$campaign_id=isset($_REQUEST['campaignId']) ? $_REQUEST['campaignId'] : 0;
			$groupId = isset($_SESSION['user_group']) ? $_SESSION['user_group'] : 0;
			$clientSearch=isset($_REQUEST['clientId']) ? $_REQUEST['clientId'] :$_SESSION['search_client_id'];
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/campaigns/client_campains';
			// Tool name
			//$toolName = 'iprscan';
		    ...
		    $arrData=json_decode($jobId,true);
			$arr=array();
			$arr['start_date']=isset($arrData[0]['start_date'])? $arrData[0]['start_date']:'';
			$arr['end_date']=isset($arrData[0]['end_date']) ? $arrData[0]['end_date']:'';
			$arr['client_id']=isset($arrData[0]['client_id']) ?$arrData[0]['client_id']:'';
			$arr['campaign_id']=isset($arrData[0]['campaign_id'])? $arrData[0]['campaign_id']:'';
			$arr['campaign_name']=isset($arrData[0]['campaign_name']) ? $arrData[0]['campaign_name'] : '';
			$arr['client_name']=isset($arrData[0]['name']) ? $arrData[0]['name'] : ''; 
			/* $_SESSION['start_date']=isset($arrData[0]['start_date'])? $arrData[0]['start_date']:'';
			$_SESSION['end_date']=isset($arrData[0]['end_date']) ? $arrData[0]['end_date']:'';
			$_SESSION['search_client_id']=isset($arrData[0]['client_id']) ?$arrData[0]['client_id']:'';
			$_SESSION['search_campaign_id']=isset($arrData[0]['campaign_id'])? $arrData[0]['campaign_id']:''; */
	...
	function modShowAllDownloads($start_date,$end_date)
	{
		try
		{
			global $config;
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/downloads';
			// Tool name
			//$toolName = 'iprscan';
            ...
            // Close the cURL session
			curl_close($curl);
			include SRV_ROOT.'views/analytics/app_downloads.tpl.php';
		}
		catch ( Exception $e ) {
			echo 'Message: ' .$e->getMessage();
		}
	...
	function modShowOnlineUsers()
	{
		try
		{
			...
			$groupId = isset($_SESSION['user_group']) ? $_SESSION['user_group'] : 0;
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/online_users';
			// Tool name
			//$toolName = 'iprscan';
			...
			$arrData=json_decode($jobId,true);
			$arr=array();
			$arr['onlineUsers']=isset($arrData[0]['onlineUsers']) ? $arrData[0]['onlineUsers'] : 0;
			echo json_encode($arr);
            // Close the cURL session
			curl_close($curl);
		}
	...
	function modShowTotalDownloads()
	{
		try
		{
			global $config;
			...
			// Base URL for the service
			$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/total_downloads';
			// Tool name
			//$toolName = 'iprscan';
			...
			$arrData=json_decode($jobId,true);
			$arr=array();
			$arr['total_downloads']=isset($arrData[0]['total_downloads']) ? $arrData[0]['total_downloads'] : 0;
			echo json_encode($arr);
            // Close the cURL session
			curl_close($curl);
    ...
    function modShowProductViews()
	{
		try
		{
			...
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/product_views_Info/products';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/total';
			// Parameters for call
			$params = array();
			$params['group_id']=$groupId;
			$params['end_date']=$end_date;
			...
			//print_r($arrData);
			$arr=array();
			$arr['productViews']=isset($arrData['product_views_total']) ? $arrData['product_views_total'] : 0;
			echo json_encode($arr);
			curl_close($curl);
		}
		catch ( Exception $e ) {
	...
	function modShowOfferViews()
	{
		try
		{
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/product_views_Info/offers';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/total';
			// Tool name
			//$toolName = 'iprscan';
		  ...
		  //  echo "$jobId\n";
			...
			//print_r($arrData);
			$arr=array();
			$arr['offerViews']=isset($arrData['offer_views_total']) ? $arrData['offer_views_total'] : 0;
		     echo json_encode($arr);
			curl_close($curl);
		}
		catch ( Exception $e ) {
...
function modShowProductShareViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/product_views_Info/productshares';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/total/shares';
			// Tool name
			//$toolName = 'iprscan';
			...
			$arrData=json_decode($jobId,true);
			$arr=array();
			$arr['product_shareViews']=isset($arrData['sharedViewsTotal']) ? $arrData['sharedViewsTotal'] : 0;
			echo json_encode($arr);
			curl_close($curl);
		}
		catch ( Exception $e ) {
    ...
    function modShowOfferShareViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/product_views_Info/offershares';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/total/shares';
			...
			$arrData=json_decode($jobId,true);
			$arr=array();
		    $arr['offer_shareViews']=isset($arrData['sharedViewsTotal']) ? $arrData['sharedViewsTotal'] : 0;
			echo json_encode($arr);
			curl_close($curl);
		}
		catch ( Exception $e ) {
    ...
    function modShowOfferGraphViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/graphs_Info/offers';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/graph';
			// Tool name
	...
	function modShowProductGraphViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/graph';
	...
	function modShowProductShareGraphViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/graphs_Info/productshares';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/products/views/graph/shares';
			// Tool name
	...
	function modShowOfferShareGraphViews()
	{
		try
		{
			global $config;
			...
			$campaign_id=isset($_REQUEST['campaign_id']) ? $_REQUEST['campaign_id'] : 0;
			// Base URL for the service
			//$baseUrl = $config['LIVE_URL'].'data_analytics/webservices/graphs_Info/offershares';
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/graph/shares';
			// Tool name
	...
	public function modShowAnalyticsOffersList($sendArray){
		try{	
			global $config;

			// Base URL for the service
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/list';
			// Parameters for call
			$params = array();
			$params['start_date']=$sendArray['start_date'];
			$params['end_date']=$sendArray['end_date'];
			...
			*/
			...
			include SRV_ROOT.'views/analytics/offers_views_list.tpl.php';
        ...
        function modShowAnalyticsOffersDetails($sendArray)
	{
		try
		{
			global $config;
			...
			// Base URL for the service
			$baseUrl = $config['ANALYTICS_WS_LIVE_URL'].'public/analytics/offers/views/details/'; 
			// Parameters for call
			$params = array();
			$params['start_date']=$sendArray['start_date'];
			$params['end_date']=$sendArray['end_date'];
			$params['offer_id']=$sendArray['offer_id'];
			$params['client_id']=$sendArray['client_id'];
			...
			include SRV_ROOT.'views/analytics/offer_views_details.tpl.php';
