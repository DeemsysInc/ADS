	...
	public function pageContent($pUrl){
		try{
            ...
            elseif (isset($pUrl[2]) && $pUrl[2]=='campaigns'){
            	...
            	elseif (isset($pUrl[3]) && $pUrl[3]=='clients'){
            		$this->objPublic->modShowMobileUserClientCampaignDetails();
            	}
				elseif (isset($pUrl[3]) && $pUrl[3]=='client_campains'){
            		$this->objPublic->modShowMobileUserCampaignDetails();
            	}
				
            }
			elseif (isset($pUrl[2]) && $pUrl[2]=='downloads'){
				$this->objPublic->modShowAllDownloads();
            }
			elseif (isset($pUrl[2]) && $pUrl[2]=='total_downloads'){
				$this->objPublic->modShowMobileUserAllDownloads();
            }
			elseif (isset($pUrl[2]) && $pUrl[2]=='online_users'){
				$this->objPublic->modShowOnlineUsers();
            }
			 elseif (isset($pUrl[2]) && $pUrl[2]=='product_views_Info'){
				if (isset($pUrl[3]) && $pUrl[3]=='products'){
            		$this->objPublic->modShowMobileUserProductViewsInfo();
            	}
			  elseif (isset($pUrl[3]) && $pUrl[3]=='offers'){
				$this->objPublic->modShowMobileUserOfferViewsInfo();
                } 
				elseif (isset($pUrl[3]) && $pUrl[3]=='productshares'){
				$this->objPublic->modShowMobileUserProductShareViewsInfo();
                } 
				elseif (isset($pUrl[3]) && $pUrl[3]=='offershares'){
				$this->objPublic->modShowMobileUserOfferShareViewsInfo();
                } 
            } 
			 elseif (isset($pUrl[2]) && $pUrl[2]=='graphs_Info'){
				if (isset($pUrl[3]) && $pUrl[3]=='products'){
            		$this->objPublic->modShowMobileUserProductViewsForGraph();
            	}
			  elseif (isset($pUrl[3]) && $pUrl[3]=='offers'){
				$this->objPublic->modShowMobileUserOfferViewsForGraph();
                } 
				elseif (isset($pUrl[3]) && $pUrl[3]=='productshares'){
				$this->objPublic->modShowMobileUserProductShareViewsForGraph();
                } 
				elseif (isset($pUrl[3]) && $pUrl[3]=='offershares'){
				$this->objPublic->modShowMobileUserOfferShareViewsForGraph();
                } 
            } 
			...
			elseif (isset($pUrl[2]) && $pUrl[2]=='byproductshares'){
            	$this->objPublic->modShowMobileUseTrackDataByProductShares();
			}
			elseif (isset($pUrl[2]) && $pUrl[2]=='byofferShares'){
            	$this->objPublic->modShowMobileUseTrackDataByOfferShares();
			}
