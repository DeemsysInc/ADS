...
class cAppLogin{
	...
	public function login_app_user($vArray){
		...
		if(count($checkLogin) >0){
			...
			$updateRecord = $this->objLoginQuery->updateRecordQuery($udArray, $this->usersDbName.".`user_details`", $con);
		}else{
				...
				if($uid!=0){
					...
					if($con['user_id'] !=0){
						...
						if($updateRecord){
							...
							$udArray = array();	
							$con['user_id'] = $arrResult['id'];	
							$udArray['".$this->usersDbName.".`users` _lastlogin'] = 'NOW()';
							$updateRecord = $this->objLoginQuery->updateRecordQuery($udArray, "".$this->usersDbName.".`users` ", $con);
						}else{
							$arrResult['msg']='fail';
						}
					}
	...
	public function getInsertRegistrationDetails($pArray){
		try{
			...
			if(count($checkUserReg)==0 && $pArray['user_username']!=""){
				...
				$pUserDetailsTableName = "".$this->usersDbName.".`users` ";
				$dArray['user_id'] = $insertedUsersResultId;
				$dArray['".$this->usersDbName.".`users` _avatar'] = isset($_REQUEST['".$this->usersDbName.".`users` _avatar']) ? $_REQUEST['".$this->usersDbName.".`users` _avatar'] : '';
				$dArray['".$this->usersDbName.".`users` _nickname'] = isset($_REQUEST['".$this->usersDbName.".`users` _nickname']) ? $_REQUEST['".$this->usersDbName.".`users` _nickname'] : $pArray['user_firstname'];
				$dArray['".$this->usersDbName.".`users` _phone'] = isset($_REQUEST['".$this->usersDbName.".`users` _phone']) ? $_REQUEST['".$this->usersDbName.".`users` _phone'] : '';
				$dArray['".$this->usersDbName.".`users` _address1'] = isset($_REQUEST['".$this->usersDbName.".`users` _address1']) ? $_REQUEST['".$this->usersDbName.".`users` _address1'] : '';
				$dArray['".$this->usersDbName.".`users` _address2'] = isset($_REQUEST['".$this->usersDbName.".`users` _address2']) ? $_REQUEST['".$this->usersDbName.".`users` _address2'] : '';
				$dArray['".$this->usersDbName.".`users` _city'] = isset($_REQUEST['".$this->usersDbName.".`users` _city']) ? $_REQUEST['".$this->usersDbName.".`users` _city'] : '';
				$dArray['".$this->usersDbName.".`users` _state'] = isset($_REQUEST['".$this->usersDbName.".`users` _state']) ? $_REQUEST['".$this->usersDbName.".`users` _state'] : '';
				$dArray['".$this->usersDbName.".`users` _country'] = isset($_REQUEST['".$this->usersDbName.".`users` _country']) ? $_REQUEST['".$this->usersDbName.".`users` _country'] : '';
				$dArray['".$this->usersDbName.".`users` _zip'] = isset($_REQUEST['".$this->usersDbName.".`users` _zip']) ? $_REQUEST['".$this->usersDbName.".`users` _zip'] : '';
			
				$dArray['".$this->usersDbName.".`users` _gender'] = isset($_REQUEST['".$this->usersDbName.".`users` _gender']) ? $_REQUEST['".$this->usersDbName.".`users` _gender'] : '';
				//$dArray['".$this->usersDbName.".`users` _dob'] = isset($_REQUEST['".$this->usersDbName.".`users` _dob']) ?  date("Y-m-d", strtotime($_REQUEST['".$this->usersDbName.".`users` _dob'])) : '';
				$dArray['".$this->usersDbName.".`users` _lastlogin'] = 'NOW()';
				...
				if ($insertedUsersDetailsResultId && $pArray['user_username']!=""){
					...
					$pUserTrackingTableName = $this->usersDbName.".user_tracking" ;
			
					$utArray = array();
					$utArray['user_id'] = $insertedUsersResultId;
					$utArray['user_group_id'] = 0;
					$utArray['".$this->usersDbName.".`users` _id'] = $insertedUsersDetailsResultId;
