...
class mMyOffers extends SQLQuery {
	...
	function getClientWithOfferDetailsWithUserIdOrOfferID($loggedInUserId, $offerId, $flag)
	{
		...
		of.offer_is_location_based, of.offer_is_sharable,of.offer_is_calendar_based, oi.offer_info_event_start, oi.offer_info_event_end, 
	...
	function getClientWithRelatedOffers($clientId, $offerId, $layoutType)
	{
		...
		oai.offer_id AS tapForDetailsImgPdId, cl.id AS clientId, cl.name, cl.background_color, cl.light_color, cl.dark_color,cl.client_vertical_id, `ofr`.relatedto_id, 
...
*/
		...
		if($layoutType!="financial"){
			...
			$query .= " GROUP BY of.offer_id DESC";
		}
		//$query .= " GROUP BY of.offer_id DESC LIMIT 0,5";
