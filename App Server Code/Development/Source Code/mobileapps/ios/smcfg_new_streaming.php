...
$config['files']['logo'] = 'http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/logo/';
$config['files']['background'] = 'http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/background/';
$config['files']['triggers'] = 'http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/triggers/';
$config['files']['products'] = 'http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/products/';
$config['files']['additional']='http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/additional/';
$config['files']['videos']='http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/videos/';
$config['files']['models']='http://183.82.0.112:8890/seemore/dev/'.'files/clients/{client_id}/models/';
$config['files']['videostream']='rtmp://183.82.0.112:8845/vod/';
