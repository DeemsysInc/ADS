...
<div></div>
<div class="heading"><b>Contact Us</b></div><br />
<div class="desc">
Please enter your preferences in the form. We will contact you on the next business day to schedule an appointment. For more immediate assistance, please call our office during business hours.<br />
</div>
<?php /*?><p bgcolor="#19594F" class="head">SHOP WELL</p><?php */?>
<form name="form" id="form" action="<?php echo $config['LIVE_URL']."/mobileapps/web/credit_app/".$arrClientDetails[0]['id']."/action"; ?>" method="post">
...
<div id="enterComments" class="label">Comments</div>

<div id="afterComments"><input onfocus="if (this.value == 'Enter your comments.'){ this.value='', this.className='boxes'}" value="<?php echo $comments;?>"   onblur="if (this.value == ''){this.value = 'Enter your comments.',this.className='hint'}" type="text" class="<?php echo $lclassname;?>" name="comments" id="comments"/></div>
