...
class mDashboard extends SQLQuery {
	...
	{
	    $query = "SELECT * FROM `users` AS `u` , `user_details` AS `ud` WHERE `u`.`user_id`=`ud`.`user_id` AND `u`.`user_group_id`='3'AND `u`.`user_status`!='2' ORDER BY `u`.`user_created_date` DESC"; 
