$(document).ready(function() { 
    ...
    $("#frm_save_client").validate({
        ...
        messages: {
            c_name: "Please enter client name",
			c_logo: "File must be JPG,or PNG"
        ...
        submitHandler: function(form) {
			...
			/* m_data.append( 'c_name', $('input[name=c_name]').val());
            m_data.append( 'c_logo', $('input[name=c_logo]').val());
            m_data.append( 'c_bgimage', $('input[name=c_bgimage]').val());
            m_data.append( 'c_prefix', $('input[name=c_prefix]').val());
            m_data.append( 'c_status', $('select[name=c_status]').val());
			m_data.append( 'c_website', $('input[name=c_website]').val());
			m_data.append( 'bcid', $('input[name=bcid]').val());
			m_data.append( 'lcid', $('input[name=lcid]').val());
			m_data.append( 'dcid', $('input[name=dcid]').val());
			m_data.append( 'c_is_demo', $('select[name=c_is_demo]').val());
			m_data.append( 'c_client_vertical', $('select[name=c_client_vertical]').val());
			m_data.append( 'c_is_location_based', $('select[name=c_is_location_based]').val());
			m_data.append( 'c_is_affiliate', $('select[name=c_is_affiliate]').val());
			m_data.append( 'store_notify_msg', $('textarea[name=store_notify_msg]').val());
			m_data.append( 'c_is_affiliate', $('select[name=c_is_affiliate]').val());
			m_data.append( 'c_company', $('input[name=c_company]').val());
			m_data.append( 'c_address', $('input[name=c_address]').val());
			m_data.append( 'c_country', $('select[name=c_country]').val());
			m_data.append( 'c_state', $('select[name=c_state]').val());
			m_data.append( 'c_city', $('input[name=c_city]').val());
			m_data.append( 'c_zip', $('input[name=c_zip]').val());
			m_data.append( 'c_phone', $('input[name=c_phone]').val());
			
			m_data.append( 'c_email', $('input[name=c_email]').val());
			m_data.append( 'c_currency_code', $('input[name=c_currency_code]').val());
			m_data.append( 'c_shipping_methods', $('input[name=c_shipping_methods]').val());
			m_data.append( 'c_payment_methods', $('input[name=c_payment_methods]').val());
			m_data.append( 'c_phone', $('input[name=c_phone]').val());
			m_data.append( 'c_id', $('input[name=c_id]').val()); */
