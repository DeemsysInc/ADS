...
var opts=$(_60c).combobox("options");
if(opts.multiple){
return $(_60c).combobox("getValues").join(opts.separator);
}else{
return $(_60c).combobox("getValue");
}
},setValue:function(_60d,_60e){
var opts=$(_60d).combobox("options");
if(opts.multiple){
if(_60e==""){
$(_60d).combobox("clear");
}else{
$(_60d).combobox("setValues",_60e.split(opts.separator));
}
}else{
...
for(var i=0;i<rows.length;i++){
var css=opts.rowStyler?opts.rowStyler.call(_646,i,rows[i]):"";
var _64c="";
var _64d="";
...
var cls="class=\"datagrid-row "+(i%2&&opts.striped?"datagrid-row-alt ":" ")+_64c+"\"";
var _64e=_64d?"style=\""+_64d+"\"":"";
var _64f=_649.rowIdPrefix+"-"+(_648?1:2)+"-"+i;
_64b.push("<tr id=\""+_64f+"\" datagrid-row-index=\""+i+"\" "+cls+" "+_64e+">");
...
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_65a+"</div></td>");
}
...
if(col){
var _65c=_659[_65b];
var css=col.styler?(col.styler(_65c,_659,_658)||""):"";
var _65d="";
var _65e="";
if(typeof css=="string"){
_65e=css;
...
var cls=_65d?"class=\""+_65d+"\"":"";
var _65f=col.hidden?"style=\"display:none;"+_65e+"\"":(_65e?"style=\""+_65e+"\"":"");
cc.push("<td field=\""+_65b+"\" "+cls+" "+_65f+">");
if(col.checkbox){
var _65f="";
}else{
var _65f=_65e;
if(col.align){
_65f+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_65f+=";white-space:normal;height:auto;";
}else{
...
return cc.join("");
},refreshRow:function(_660,_661){
this.updateRow.call(this,_660,_661,{});
},updateRow:function(_662,_663,row){
var opts=$.data(_662,"datagrid").options;
var rows=$(_662).datagrid("getRows");
$.extend(rows[_663],row);
var css=opts.rowStyler?opts.rowStyler.call(_662,_663,rows[_663]):"";
var _664="";
var _665="";
if(typeof css=="string"){
_665=css;
...
var _664="datagrid-row "+(_663%2&&opts.striped?"datagrid-row-alt ":" ")+_664;
function _666(_667){
var _668=$(_662).datagrid("getColumnFields",_667);
var tr=opts.finder.getTr(_662,_663,"body",(_667?1:2));
var _669=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow.call(this,_662,_668,_667,_663,rows[_663]));
tr.attr("style",_665).attr("class",_664);
if(_669){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
_666.call(this,true);
_666.call(this,false);
$(_662).datagrid("fixRowHeight",_663);
},insertRow:function(_66a,_66b,row){
var _66c=$.data(_66a,"datagrid");
var opts=_66c.options;
var dc=_66c.dc;
var data=_66c.data;
if(_66b==undefined||_66b==null){
_66b=data.rows.length;
}
if(_66b>data.rows.length){
_66b=data.rows.length;
}
function _66d(_66e){
var _66f=_66e?1:2;
for(var i=data.rows.length-1;i>=_66b;i--){
var tr=opts.finder.getTr(_66a,i,"body",_66f);
tr.attr("datagrid-row-index",i+1);
tr.attr("id",_66c.rowIdPrefix+"-"+_66f+"-"+(i+1));
if(_66e&&opts.rownumbers){
var _670=i+2;
if(opts.pagination){
_670+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_670);
}
if(opts.striped){
...
function _671(_672){
var _673=_672?1:2;
var _674=$(_66a).datagrid("getColumnFields",_672);
var _675=_66c.rowIdPrefix+"-"+_673+"-"+_66b;
var tr="<tr id=\""+_675+"\" class=\"datagrid-row\" datagrid-row-index=\""+_66b+"\"></tr>";
if(_66b>=data.rows.length){
if(data.rows.length){
opts.finder.getTr(_66a,"","last",_673).after(tr);
}else{
var cc=_672?dc.body1:dc.body2;
cc.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
opts.finder.getTr(_66a,_66b+1,"body",_673).before(tr);
}
};
_66d.call(this,true);
_66d.call(this,false);
_671.call(this,true);
_671.call(this,false);
data.total+=1;
data.rows.splice(_66b,0,row);
this.refreshRow.call(this,_66a,_66b);
},deleteRow:function(_676,_677){
var _678=$.data(_676,"datagrid");
var opts=_678.options;
var data=_678.data;
function _679(_67a){
var _67b=_67a?1:2;
for(var i=_677+1;i<data.rows.length;i++){
var tr=opts.finder.getTr(_676,i,"body",_67b);
tr.attr("datagrid-row-index",i-1);
tr.attr("id",_678.rowIdPrefix+"-"+_67b+"-"+(i-1));
if(_67a&&opts.rownumbers){
var _67c=i;
if(opts.pagination){
_67c+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_67c);
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
opts.finder.getTr(_676,_677).remove();
_679.call(this,true);
_679.call(this,false);
data.total-=1;
data.rows.splice(_677,1);
},onBeforeRender:function(_67d,rows){
},onAfterRender:function(_67e){
var opts=$.data(_67e,"datagrid").options;
if(opts.showFooter){
var _67f=$(_67e).datagrid("getPanel").find("div.datagrid-footer");
_67f.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_680,_681){
},loader:function(_682,_683,_684){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_682,dataType:"json",success:function(data){
_683(data);
},error:function(){
_684.apply(this,arguments);
}});
...
},editors:_5d5,finder:{getTr:function(_685,_686,type,_687){
type=type||"body";
_687=_687||0;
var _688=$.data(_685,"datagrid");
var dc=_688.dc;
var opts=_688.options;
if(_687==0){
var tr1=opts.finder.getTr(_685,_686,type,1);
var tr2=opts.finder.getTr(_685,_686,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_688.rowIdPrefix+"-"+_687+"-"+_686);
if(!tr.length){
tr=(_687==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_686+"]");
}
return tr;
}else{
if(type=="footer"){
return (_687==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_686+"]");
}else{
if(type=="selected"){
return (_687==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_687==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_687==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row:has(div.datagrid-cell-check input:checked)");
}else{
if(type=="last"){
return (_687==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_687==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_687==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_689,p){
var _68a=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_689,"datagrid").data.rows[parseInt(_68a)];
}},view:_645,onBeforeLoad:function(_68b){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_68c,_68d){
},onDblClickRow:function(_68e,_68f){
},onClickCell:function(_690,_691,_692){
},onDblClickCell:function(_693,_694,_695){
},onSortColumn:function(sort,_696){
},onResizeColumn:function(_697,_698){
},onSelect:function(_699,_69a){
},onUnselect:function(_69b,_69c){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onCheck:function(_69d,_69e){
},onUncheck:function(_69f,_6a0){
},onCheckAll:function(rows){
},onUncheckAll:function(rows){
},onBeforeEdit:function(_6a1,_6a2){
},onAfterEdit:function(_6a3,_6a4,_6a5){
},onCancelEdit:function(_6a6,_6a7){
},onHeaderContextMenu:function(e,_6a8){
},onRowContextMenu:function(e,_6a9,_6aa){
}});
})(jQuery);
(function($){
var _6ab;
function _6ac(_6ad){
var _6ae=$.data(_6ad,"propertygrid");
var opts=$.data(_6ad,"propertygrid").options;
$(_6ad).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?_6af:undefined),onClickRow:function(_6b0,row){
if(_6ab!=this){
_6b1(_6ab);
_6ab=this;
}
if(opts.editIndex!=_6b0&&row.editor){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_6b1(_6ab);
$(this).datagrid("beginEdit",_6b0);
$(this).datagrid("getEditors",_6b0)[0].target.focus();
opts.editIndex=_6b0;
}
opts.onClickRow.call(_6ad,_6b0,row);
},loadFilter:function(data){
_6b1(this);
return opts.loadFilter.call(this,data);
},onLoadSuccess:function(data){
$(_6ad).datagrid("getPanel").find("div.datagrid-group").attr("style","");
opts.onLoadSuccess.call(_6ad,data);
}}));
...
var opts=$.data(_6b2,"propertygrid").options;
var _6b3=opts.editIndex;
if(_6b3==undefined){
return;
}
var ed=t.datagrid("getEditors",_6b3)[0];
if(ed){
ed.target.blur();
if(t.datagrid("validateRow",_6b3)){
t.datagrid("endEdit",_6b3);
}else{
t.datagrid("cancelEdit",_6b3);
}
}
opts.editIndex=undefined;
};
$.fn.propertygrid=function(_6b4,_6b5){
if(typeof _6b4=="string"){
var _6b6=$.fn.propertygrid.methods[_6b4];
if(_6b6){
return _6b6(this,_6b5);
}else{
return this.datagrid(_6b4,_6b5);
}
}
_6b4=_6b4||{};
return this.each(function(){
var _6b7=$.data(this,"propertygrid");
if(_6b7){
$.extend(_6b7.options,_6b4);
}else{
var opts=$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_6b4);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.columns=$.extend(true,[],opts.columns);
...
$.fn.propertygrid.parseOptions=function(_6b8){
var t=$(_6b8);
return $.extend({},$.fn.datagrid.parseOptions(_6b8),$.parser.parseOptions(_6b8,[{showGroup:"boolean"}]));
};
var _6af=$.extend({},$.fn.datagrid.defaults.view,{render:function(_6b9,_6ba,_6bb){
var _6bc=$.data(_6b9,"datagrid");
var opts=_6bc.options;
var rows=_6bc.data.rows;
var _6bd=$(_6b9).datagrid("getColumnFields",_6bb);
var _6be=[];
var _6bf=0;
var _6c0=this.groups;
for(var i=0;i<_6c0.length;i++){
var _6c1=_6c0[i];
_6be.push("<div class=\"datagrid-group\" group-index="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
_6be.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_6be.push("<tr>");
_6be.push("<td style=\"border:0;\">");
if(!_6bb){
_6be.push("<span style=\"color:#666;font-weight:bold;\">");
_6be.push(opts.groupFormatter.call(_6b9,_6c1.fvalue,_6c1.rows));
_6be.push("</span>");
}
_6be.push("</td>");
_6be.push("</tr>");
_6be.push("</tbody></table>");
_6be.push("</div>");
_6be.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
for(var j=0;j<_6c1.rows.length;j++){
var cls=(_6bf%2&&opts.striped)?"class=\"datagrid-row datagrid-row-alt\"":"class=\"datagrid-row\"";
var _6c2=opts.rowStyler?opts.rowStyler.call(_6b9,_6bf,_6c1.rows[j]):"";
var _6c3=_6c2?"style=\""+_6c2+"\"":"";
var _6c4=_6bc.rowIdPrefix+"-"+(_6bb?1:2)+"-"+_6bf;
_6be.push("<tr id=\""+_6c4+"\" datagrid-row-index=\""+_6bf+"\" "+cls+" "+_6c3+">");
_6be.push(this.renderRow.call(this,_6b9,_6bd,_6bb,_6bf,_6c1.rows[j]));
_6be.push("</tr>");
_6bf++;
}
_6be.push("</tbody></table>");
...
$(_6ba).html(_6be.join(""));
},onAfterRender:function(_6c5){
var opts=$.data(_6c5,"datagrid").options;
var dc=$.data(_6c5,"datagrid").dc;
var view=dc.view;
var _6c6=dc.view1;
var _6c7=dc.view2;
$.fn.datagrid.defaults.view.onAfterRender.call(this,_6c5);
if(opts.rownumbers||opts.frozenColumns.length){
var _6c8=_6c6.find("div.datagrid-group");
}else{
var _6c8=_6c7.find("div.datagrid-group");
}
$("<td style=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>").insertBefore(_6c8.find("td"));
view.find("div.datagrid-group").each(function(){
var _6c9=$(this).attr("group-index");
$(this).find("span.datagrid-row-expander").bind("click",{groupIndex:_6c9},function(e){
if($(this).hasClass("datagrid-row-collapse")){
$(_6c5).datagrid("collapseGroup",e.data.groupIndex);
}else{
$(_6c5).datagrid("expandGroup",e.data.groupIndex);
}
});
});
},onBeforeRender:function(_6ca,rows){
var opts=$.data(_6ca,"datagrid").options;
var _6cb=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _6cc=_6cd(row[opts.groupField]);
if(!_6cc){
_6cc={fvalue:row[opts.groupField],rows:[row],startRow:i};
_6cb.push(_6cc);
}else{
_6cc.rows.push(row);
}
...
for(var i=0;i<_6cb.length;i++){
var _6cc=_6cb[i];
for(var j=0;j<_6cc.rows.length;j++){
_6d0.push(_6cc.rows[j]);
}
}
$.data(_6ca,"datagrid").data.rows=_6d0;
}});
$.extend($.fn.datagrid.methods,{expandGroup:function(jq,_6d1){
return jq.each(function(){
...
if(_6d3.hasClass("datagrid-row-expand")){
_6d3.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_6d2.next("table").show();
}
$(this).datagrid("fixRowHeight");
});
},collapseGroup:function(jq,_6d4){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
if(_6d4!=undefined){
var _6d5=view.find("div.datagrid-group[group-index=\""+_6d4+"\"]");
}else{
var _6d5=view.find("div.datagrid-group");
}
var _6d6=_6d5.find("span.datagrid-row-expander");
if(_6d6.hasClass("datagrid-row-collapse")){
_6d6.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_6d5.next("table").hide();
}
$(this).datagrid("fixRowHeight");
});
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_6d7,rows){
return _6d7;
}});
})(jQuery);
(function($){
function _6d8(_6d9){
var _6da=$.data(_6d9,"treegrid");
var opts=_6da.options;
$(_6d9).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
},onLoadSuccess:function(){
},onResizeColumn:function(_6db,_6dc){
_6f2(_6d9);
opts.onResizeColumn.call(_6d9,_6db,_6dc);
},onSortColumn:function(sort,_6dd){
opts.sortName=sort;
opts.sortOrder=_6dd;
if(opts.remoteSort){
_6f1(_6d9);
}else{
var data=$(_6d9).treegrid("getData");
_707(_6d9,0,data);
}
opts.onSortColumn.call(_6d9,sort,_6dd);
},onBeforeEdit:function(_6de,row){
if(opts.onBeforeEdit.call(_6d9,row)==false){
return false;
}
},onAfterEdit:function(_6df,row,_6e0){
opts.onAfterEdit.call(_6d9,row,_6e0);
},onCancelEdit:function(_6e1,row){
opts.onCancelEdit.call(_6d9,row);
},onSelect:function(_6e2){
opts.onSelect.call(_6d9,find(_6d9,_6e2));
},onUnselect:function(_6e3){
opts.onUnselect.call(_6d9,find(_6d9,_6e3));
},onSelectAll:function(){
opts.onSelectAll.call(_6d9,$.data(_6d9,"treegrid").data);
},onUnselectAll:function(){
opts.onUnselectAll.call(_6d9,$.data(_6d9,"treegrid").data);
},onCheck:function(_6e4){
opts.onCheck.call(_6d9,find(_6d9,_6e4));
},onUncheck:function(_6e5){
opts.onUncheck.call(_6d9,find(_6d9,_6e5));
},onCheckAll:function(){
opts.onCheckAll.call(_6d9,$.data(_6d9,"treegrid").data);
},onUncheckAll:function(){
opts.onUncheckAll.call(_6d9,$.data(_6d9,"treegrid").data);
},onClickRow:function(_6e6){
opts.onClickRow.call(_6d9,find(_6d9,_6e6));
},onDblClickRow:function(_6e7){
opts.onDblClickRow.call(_6d9,find(_6d9,_6e7));
},onClickCell:function(_6e8,_6e9){
opts.onClickCell.call(_6d9,_6e9,find(_6d9,_6e8));
},onDblClickCell:function(_6ea,_6eb){
opts.onDblClickCell.call(_6d9,_6eb,find(_6d9,_6ea));
},onRowContextMenu:function(e,_6ec){
opts.onContextMenu.call(_6d9,e,find(_6d9,_6ec));
}}));
if(!opts.columns){
var _6ed=$.data(_6d9,"datagrid").options;
opts.columns=_6ed.columns;
opts.frozenColumns=_6ed.frozenColumns;
}
_6da.dc=$.data(_6d9,"datagrid").dc;
if(opts.pagination){
var _6ee=$(_6d9).datagrid("getPager");
_6ee.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_6ef,_6f0){
opts.pageNumber=_6ef;
opts.pageSize=_6f0;
_6f1(_6d9);
}});
opts.pageSize=_6ee.pagination("options").pageSize;
}
};
function _6f2(_6f3,_6f4){
var opts=$.data(_6f3,"datagrid").options;
var dc=$.data(_6f3,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight)){
if(_6f4!=undefined){
var _6f5=_6f6(_6f3,_6f4);
for(var i=0;i<_6f5.length;i++){
_6f7(_6f5[i][opts.idField]);
}
}
}
$(_6f3).datagrid("fixRowHeight",_6f4);
function _6f7(_6f8){
var tr1=opts.finder.getTr(_6f3,_6f8,"body",1);
var tr2=opts.finder.getTr(_6f3,_6f8,"body",2);
tr1.css("height","");
tr2.css("height","");
var _6f9=Math.max(tr1.height(),tr2.height());
tr1.css("height",_6f9);
tr2.css("height",_6f9);
};
};
...
var _6fe=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
...
var tr1=opts.finder.getTr(_701,_702,"body",1);
var tr2=opts.finder.getTr(_701,_702,"body",2);
var _703=$(_701).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _704=$(_701).datagrid("getColumnFields",false).length;
_705(tr1,_703);
_705(tr2,_704);
function _705(tr,_706){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_706+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _707(_708,_709,data,_70a){
var _70b=$.data(_708,"treegrid");
var opts=_70b.options;
var dc=_70b.dc;
data=opts.loadFilter.call(_708,data,_709);
var node=find(_708,_709);
if(node){
var _70c=opts.finder.getTr(_708,_709,"body",1);
var _70d=opts.finder.getTr(_708,_709,"body",2);
var cc1=_70c.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_70d.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_70a){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_708,_709,data);
}
opts.view.render.call(opts.view,_708,cc1,true);
opts.view.render.call(opts.view,_708,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_708,dc.footer1,true);
opts.view.renderFooter.call(opts.view,_708,dc.footer2,false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_708);
}
opts.onLoadSuccess.call(_708,node,data);
if(!_709&&opts.pagination){
var _70e=$.data(_708,"treegrid").total;
var _70f=$(_708).datagrid("getPager");
if(_70f.pagination("options").total!=_70e){
_70f.pagination({total:_70e});
}
}
_6f2(_708);
_6fa(_708);
...
function _6f1(_710,_711,_712,_713,_714){
var opts=$.data(_710,"treegrid").options;
var body=$(_710).datagrid("getPanel").find("div.datagrid-body");
if(_712){
opts.queryParams=_712;
}
var _715=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_715,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_715,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_710,_711);
if(opts.onBeforeLoad.call(_710,row,_715)==false){
return;
}
var _716=body.find("tr[node-id="+_711+"] span.tree-folder");
_716.addClass("tree-loading");
$(_710).treegrid("loading");
var _717=opts.loader.call(_710,_715,function(data){
_716.removeClass("tree-loading");
$(_710).treegrid("loaded");
_707(_710,_711,data,_713);
if(_714){
_714();
}
},function(){
_716.removeClass("tree-loading");
$(_710).treegrid("loaded");
opts.onLoadError.apply(_710,arguments);
if(_714){
_714();
}
});
...
function _71a(_71b){
return $.data(_71b,"treegrid").data;
};
function _71c(_71d,_71e){
var row=find(_71d,_71e);
if(row._parentId){
return find(_71d,row._parentId);
}else{
return null;
}
};
function _6f6(_71f,_720){
var opts=$.data(_71f,"treegrid").options;
var body=$(_71f).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _721=[];
if(_720){
_722(_720);
}else{
...
_721.push(_723[i]);
_722(_723[i][opts.idField]);
}
}
function _722(_724){
var _725=find(_71f,_724);
if(_725&&_725.children){
for(var i=0,len=_725.children.length;i<len;i++){
var _726=_725.children[i];
_721.push(_726);
_722(_726[opts.idField]);
}
}
};
return _721;
...
function _729(_72a){
var rows=[];
var _72b=$(_72a).datagrid("getPanel");
_72b.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_72a,id));
});
return rows;
};
...
var view=$(_72d).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id="+_72e+"]").children("td[field="+opts.treeField+"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_72f,_730){
var opts=$.data(_72f,"treegrid").options;
var data=$.data(_72f,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_730){
return node;
}else{
if(node["children"]){
...
if(opts.onBeforeCollapse.call(_732,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
var tr=opts.finder.getTr(_735,_736);
var hit=tr.find("span.tree-hit");
var row=find(_735,_736);
if(hit.length==0){
return;
}
if(hit.hasClass("tree-expanded")){
...
if(opts.onBeforeExpand.call(_735,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _737=tr.next("tr.treegrid-tr-tree");
if(_737.length){
var cc=_737.children("td").children("div");
_738(cc);
}else{
_700(_735,row[opts.idField]);
var _737=tr.next("tr.treegrid-tr-tree");
var cc=_737.children("td").children("div");
cc.hide();
var _739=$.extend({},opts.queryParams||{});
_739.id=row[opts.idField];
_6f1(_735,row[opts.idField],_739,true,function(){
if(cc.is(":empty")){
_737.remove();
}else{
_738(cc);
...
$(_735).treegrid("autoSizeColumn");
_6f2(_735,_736);
opts.onExpand.call(_735,row);
});
}else{
cc.show();
$(_735).treegrid("autoSizeColumn");
...
function _6ff(_73a,_73b){
var opts=$.data(_73a,"treegrid").options;
var tr=opts.finder.getTr(_73a,_73b);
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_731(_73a,_73b);
}else{
...
var _73f=_6f6(_73d,_73e);
if(_73e){
_73f.unshift(find(_73d,_73e));
}
for(var i=0;i<_73f.length;i++){
_731(_73d,_73f[i][opts.idField]);
}
};
function _740(_741,_742){
var opts=$.data(_741,"treegrid").options;
var _743=_6f6(_741,_742);
if(_742){
_743.unshift(find(_741,_742));
}
for(var i=0;i<_743.length;i++){
_734(_741,_743[i][opts.idField]);
}
};
function _744(_745,_746){
var opts=$.data(_745,"treegrid").options;
var ids=[];
var p=_71c(_745,_746);
while(p){
...
if(_749.parent){
var tr=opts.finder.getTr(_748,_749.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_700(_748,_749.parent);
}
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
var _74a=cell.children("span.tree-icon");
if(_74a.hasClass("tree-file")){
_74a.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_74a);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_707(_748,_749.parent,_749.data,true);
};
function _74b(_74c,_74d){
var ref=_74d.before||_74d.after;
var opts=$.data(_74c,"treegrid").options;
var _74e=_71c(_74c,ref);
_747(_74c,{parent:(_74e?_74e[opts.idField]:null),data:[_74d.data]});
_74f(true);
_74f(false);
_6fa(_74c);
function _74f(_750){
var _751=_750?1:2;
var tr=opts.finder.getTr(_74c,_74d.data[opts.idField],"body",_751);
var _752=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_74c,ref,"body",_751);
if(_74d.before){
...
var opts=$.data(_754,"treegrid").options;
var tr=opts.finder.getTr(_754,_755);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _756=del(_755);
if(_756){
if(_756.children.length==0){
tr=opts.finder.getTr(_754,_756[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field="+opts.treeField+"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _757=_71c(_754,_755);
if(_757){
cc=_757.children;
}else{
cc=$(_754).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_758,_759){
if(typeof _758=="string"){
var _75a=$.fn.treegrid.methods[_758];
if(_75a){
return _75a(this,_759);
}else{
return this.datagrid(_758,_759);
}
}
_758=_758||{};
return this.each(function(){
var _75b=$.data(this,"treegrid");
if(_75b){
$.extend(_75b.options,_758);
}else{
_75b=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_758),data:[]});
}
_6d8(this);
if(_75b.options.data){
$(this).treegrid("loadData",_75b.options.data);
}
_6f1(this);
_6fc(this);
});
...
},resize:function(jq,_75c){
return jq.each(function(){
$(this).datagrid("resize",_75c);
});
},fixRowHeight:function(jq,_75d){
return jq.each(function(){
_6f2(this,_75d);
});
},loadData:function(jq,data){
return jq.each(function(){
_707(this,data.parent,data);
});
},load:function(jq,_75e){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_75e);
});
...
_75f=$.extend({},opts.queryParams);
_75f.id=id;
}
if(_75f.id){
var node=$(this).treegrid("find",_75f.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_75f;
var tr=opts.finder.getTr(this,_75f.id);
tr.next("tr.treegrid-tr-tree").remove();
...
},reloadFooter:function(jq,_760){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_760){
$.data(this,"treegrid").footer=_760;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_761){
return jq.each(function(){
_747(this,_761);
});
},insert:function(jq,_762){
return jq.each(function(){
_74b(this,_762);
});
...
},update:function(jq,_763){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
opts.view.updateRow.call(opts.view,this,_763.id,_763.row);
});
...
$.fn.treegrid.parseOptions=function(_764){
return $.extend({},$.fn.datagrid.parseOptions(_764),$.parser.parseOptions(_764,["treeField",{animate:"boolean"}]));
};
var _765=$.extend({},$.fn.datagrid.defaults.view,{render:function(_766,_767,_768){
var opts=$.data(_766,"treegrid").options;
var _769=$(_766).datagrid("getColumnFields",_768);
var _76a=$.data(_766,"datagrid").rowIdPrefix;
if(_768){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _76b=0;
var view=this;
var _76c=_76d(_768,this.treeLevel,this.treeNodes);
$(_767).append(_76c.join(""));
function _76d(_76e,_76f,_770){
var _771=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_770.length;i++){
var row=_770[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_766,row):"";
var _772="";
var _773="";
if(typeof css=="string"){
_773=css;
...
var cls="class=\"datagrid-row "+(_76b++%2&&opts.striped?"datagrid-row-alt ":" ")+_772+"\"";
var _774=_773?"style=\""+_773+"\"":"";
var _775=_76a+"-"+(_76e?1:2)+"-"+row[opts.idField];
_771.push("<tr id=\""+_775+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_774+">");
_771=_771.concat(view.renderRow.call(view,_766,_769,_76e,_76f,row));
_771.push("</tr>");
if(row.children&&row.children.length){
var tt=_76d(_76e,_76f+1,row.children);
var v=row.state=="closed"?"none":"block";
_771.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_769.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_771=_771.concat(tt);
_771.push("</div></td></tr>");
}
}
...
},renderFooter:function(_776,_777,_778){
var opts=$.data(_776,"treegrid").options;
var rows=$.data(_776,"treegrid").footer||[];
var _779=$(_776).datagrid("getColumnFields",_778);
var _77a=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_77a.push("<tr class=\"datagrid-row\" node-id="+row[opts.idField]+">");
_77a.push(this.renderRow.call(this,_776,_779,_778,0,row));
_77a.push("</tr>");
}
_77a.push("</tbody></table>");
$(_777).html(_77a.join(""));
},renderRow:function(_77b,_77c,_77d,_77e,row){
var opts=$.data(_77b,"treegrid").options;
var cc=[];
if(_77d&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_77c.length;i++){
var _77f=_77c[i];
var col=$(_77b).datagrid("getColumnOption",_77f);
if(col){
var css=col.styler?(col.styler(row[_77f],row)||""):"";
var _780="";
var _781="";
if(typeof css=="string"){
_781=css;
...
var cls=_780?"class=\""+_780+"\"":"";
var _782=col.hidden?"style=\"display:none;"+_781+"\"":(_781?"style=\""+_781+"\"":"");
cc.push("<td field=\""+_77f+"\" "+cls+" "+_782+">");
if(col.checkbox){
var _782="";
}else{
var _782=_781;
if(col.align){
_782+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_782+=";white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_782+=";height:auto;";
}
...
cc.push(" name=\""+_77f+"\" value=\""+(row[_77f]!=undefined?row[_77f]:"")+"\"/>");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_77f],row);
}else{
val=row[_77f];
}
if(_77f==opts.treeField){
for(var j=0;j<_77e;j++){
...
return cc.join("");
},refreshRow:function(_783,id){
this.updateRow.call(this,_783,id,{});
},updateRow:function(_784,id,row){
var opts=$.data(_784,"treegrid").options;
var _785=$(_784).treegrid("find",id);
$.extend(_785,row);
var _786=$(_784).treegrid("getLevel",id)-1;
var _787=opts.rowStyler?opts.rowStyler.call(_784,_785):"";
function _788(_789){
var _78a=$(_784).treegrid("getColumnFields",_789);
var tr=opts.finder.getTr(_784,id,"body",(_789?1:2));
var _78b=tr.find("div.datagrid-cell-rownumber").html();
var _78c=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_784,_78a,_789,_786,_785));
tr.attr("style",_787||"");
tr.find("div.datagrid-cell-rownumber").html(_78b);
if(_78c){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
_788.call(this,true);
_788.call(this,false);
$(_784).treegrid("fixRowHeight",id);
},onBeforeRender:function(_78d,_78e,data){
if($.isArray(_78e)){
data={total:_78e.length,rows:_78e};
_78e=null;
}
if(!data){
return false;
}
var _78f=$.data(_78d,"treegrid");
var opts=_78f.options;
if(data.length==undefined){
if(data.footer){
_78f.footer=data.footer;
}
if(data.total){
_78f.total=data.total;
}
data=this.transfer(_78d,_78e,data.rows);
}else{
...
row._parentId=_792;
if(row.children&&row.children.length){
_790(row.children,row[opts.idField]);
}
}
};
_790(data,_78e);
}
var node=find(_78d,_78e);
if(node){
if(node.children){
...
_78f.data=_78f.data.concat(data);
}
this.sort(_78d,data);
this.treeNodes=data;
this.treeLevel=$(_78d).treegrid("getLevel",_78e);
},sort:function(_793,data){
var opts=$.data(_793,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _794=opts.sortName.split(",");
var _795=opts.sortOrder.split(",");
_796(data);
}
function _796(rows){
...
var sn=_794[i];
var so=_795[i];
var col=$(_793).treegrid("getColumnOption",sn);
var _797=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_797(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _798=rows[i].children;
if(_798&&_798.length){
_796(_798);
}
}
};
},transfer:function(_799,_79a,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_765,loader:function(_79c,_79d,_79e){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_79c,dataType:"json",success:function(data){
_79d(data);
},error:function(){
_79e.apply(this,arguments);
}});
},loadFilter:function(data,_79f){
return data;
},finder:{getTr:function(_7a0,id,type,_7a1){
type=type||"body";
_7a1=_7a1||0;
var dc=$.data(_7a0,"datagrid").dc;
if(_7a1==0){
var opts=$.data(_7a0,"treegrid").options;
var tr1=opts.finder.getTr(_7a0,id,type,1);
var tr2=opts.finder.getTr(_7a0,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_7a0,"datagrid").rowIdPrefix+"-"+_7a1+"-"+id);
if(!tr.length){
tr=(_7a1==1?dc.body1:dc.body2).find("tr[node-id="+id+"]");
}
return tr;
}else{
if(type=="footer"){
return (_7a1==1?dc.footer1:dc.footer2).find("tr[node-id="+id+"]");
}else{
if(type=="selected"){
return (_7a1==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_7a1==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_7a1==1?dc.body1:dc.body2).find("tr.datagrid-row:has(div.datagrid-cell-check input:checked)");
}else{
if(type=="last"){
return (_7a1==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_7a1==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_7a1==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_7a2,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_7a2).treegrid("find",id);
}},onBeforeLoad:function(row,_7a3){
...
},onClickCell:function(_7a4,row){
},onDblClickCell:function(_7a5,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_7a6){
},onCancelEdit:function(row){
}});
})(jQuery);
(function($){
function _7a7(_7a8,_7a9){
var opts=$.data(_7a8,"combo").options;
var _7aa=$.data(_7a8,"combo").combo;
var _7ab=$.data(_7a8,"combo").panel;
if(_7a9){
opts.width=_7a9;
}
if(isNaN(opts.width)){
...
_7aa.appendTo("body");
var _7ac=_7aa.find("input.combo-text");
var _7ad=_7aa.find(".combo-arrow");
var _7ae=opts.hasDownArrow?_7ad._outerWidth():0;
_7aa._outerWidth(opts.width)._outerHeight(opts.height);
_7ac._outerWidth(_7aa.width()-_7ae);
_7ac.css({height:_7aa.height()+"px",lineHeight:_7aa.height()+"px"});
_7ad._outerHeight(_7aa.height());
_7ab.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_7aa.outerWidth()),height:opts.panelHeight});
_7aa.insertAfter(_7a8);
};
function init(_7af){
$(_7af).addClass("combo-f").hide();
var span=$("<span class=\"combo\">"+"<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"+"<span><span class=\"combo-arrow\"></span></span>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_7af);
var _7b0=$("<div class=\"combo-panel\"></div>").appendTo("body");
_7b0.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
var _7b1=$.data(_7af,"combo");
if(_7b1){
_7b1.options.onHidePanel.call(_7af);
}
}});
var name=$(_7af).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_7af).removeAttr("name").attr("comboName",name);
}
return {combo:span,panel:_7b0};
};
function _7b2(_7b3){
...
_7b5.find(".combo-arrow").show();
}else{
_7b5.find(".combo-arrow").hide();
}
_7b6(_7b3,opts.disabled);
_7b7(_7b3,opts.readonly);
};
function _7b8(_7b9){
var _7ba=$.data(_7b9,"combo");
var _7bb=_7ba.combo.find("input.combo-text");
_7bb.validatebox("destroy");
_7ba.panel.panel("destroy");
_7ba.combo.remove();
$(_7b9).remove();
};
function _7bc(_7bd){
...
var _7bf=_7be.panel;
var _7c0=_7be.combo;
var _7c1=_7c0.find(".combo-text");
var _7c2=_7c0.find(".combo-arrow");
...
_7c1.bind("mousedown.combo",function(e){
var p=$(this).closest("div.combo-panel");
$("div.combo-panel").not(_7bf).not(p).panel("close");
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_7bd);
break;
case 40:
opts.keyHandler.down.call(_7bd);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_7bd);
return false;
case 9:
case 27:
_7c9(_7bd);
...
if(opts.editable){
if(_7be.timer){
clearTimeout(_7be.timer);
}
_7be.timer=setTimeout(function(){
var q=_7c1.val();
if(_7be.previousValue!=q){
_7be.previousValue=q;
$(_7bd).combo("showPanel");
opts.keyHandler.query.call(_7bd,_7c1.val());
_7cc(_7bd,true);
}
},opts.delay);
}
...
_7c2.bind("click.combo",function(){
if(_7bf.is(":visible")){
_7c9(_7bd);
}else{
var p=$(this).closest("div.combo-panel");
...
var _7c5=$.data(_7c4,"combo").combo;
var _7c6=$.data(_7c4,"combo").panel;
if($.fn.window){
_7c6.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_7c6.panel("move",{left:_7c5.offset().left,top:_7c7()});
if(_7c6.panel("options").closed){
_7c6.panel("open");
opts.onShowPanel.call(_7c4);
}
(function(){
if(_7c6.is(":visible")){
_7c6.panel("move",{left:_7c8(),top:_7c7()});
setTimeout(arguments.callee,200);
}
})();
function _7c8(){
var left=_7c5.offset().left;
if(left+_7c6._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_7c6._outerWidth();
}
if(left<0){
left=0;
}
...
function _7c7(){
var top=_7c5.offset().top+_7c5._outerHeight();
if(top+_7c6._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_7c5.offset().top-_7c6._outerHeight();
}
if(top<$(document).scrollTop()){
top=_7c5.offset().top+_7c5._outerHeight();
}
return top;
};
};
function _7c9(_7ca){
var _7cb=$.data(_7ca,"combo").panel;
_7cb.panel("close");
};
function _7cc(_7cd,doit){
var opts=$.data(_7cd,"combo").options;
var _7ce=$.data(_7cd,"combo").combo.find("input.combo-text");
_7ce.validatebox($.extend({},opts,{deltaX:(opts.hasDownArrow?opts.deltaX:(opts.deltaX>0?1:-1))}));
if(doit){
_7ce.validatebox("validate");
}
};
function _7b6(_7cf,_7d0){
var _7d1=$.data(_7cf,"combo");
var opts=_7d1.options;
var _7d2=_7d1.combo;
if(_7d0){
opts.disabled=true;
$(_7cf).attr("disabled",true);
_7d2.find(".combo-value").attr("disabled",true);
_7d2.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_7cf).removeAttr("disabled");
_7d2.find(".combo-value").removeAttr("disabled");
_7d2.find(".combo-text").removeAttr("disabled");
}
};
function _7b7(_7d3,mode){
var _7d4=$.data(_7d3,"combo");
var opts=_7d4.options;
opts.readonly=mode==undefined?true:mode;
_7d4.combo.find(".combo-text").attr("readonly",opts.readonly?true:(!opts.editable));
};
function _7d5(_7d6){
var _7d7=$.data(_7d6,"combo");
var opts=_7d7.options;
var _7d8=_7d7.combo;
if(opts.multiple){
_7d8.find("input.combo-value").remove();
}else{
_7d8.find("input.combo-value").val("");
}
_7d8.find("input.combo-text").val("");
};
function _7d9(_7da){
var _7db=$.data(_7da,"combo").combo;
return _7db.find("input.combo-text").val();
};
function _7dc(_7dd,text){
var _7de=$.data(_7dd,"combo").combo;
_7de.find("input.combo-text").val(text);
_7cc(_7dd,true);
$.data(_7dd,"combo").previousValue=text;
};
function _7df(_7e0){
var _7e1=[];
var _7e2=$.data(_7e0,"combo").combo;
_7e2.find("input.combo-value").each(function(){
_7e1.push($(this).val());
});
return _7e1;
};
function _7e3(_7e4,_7e5){
var opts=$.data(_7e4,"combo").options;
var _7e6=_7df(_7e4);
var _7e7=$.data(_7e4,"combo").combo;
_7e7.find("input.combo-value").remove();
var name=$(_7e4).attr("comboName");
for(var i=0;i<_7e5.length;i++){
var _7e8=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_7e7);
if(name){
_7e8.attr("name",name);
}
_7e8.val(_7e5[i]);
...
if(aa.length!=_7e5.length||_7e5.length!=_7e6.length){
if(opts.multiple){
opts.onChange.call(_7e4,_7e5,_7e6);
}else{
opts.onChange.call(_7e4,_7e5[0],_7e6[0]);
}
}
};
function _7e9(_7ea){
...
_7e3(_7f0,opts.value);
}else{
_7ec(_7f0,opts.value);
}
}else{
_7e3(_7f0,[]);
}
opts.originalValue=_7df(_7f0);
}else{
_7ec(_7f0,opts.value);
...
$.fn.combo=function(_7f1,_7f2){
if(typeof _7f1=="string"){
return $.fn.combo.methods[_7f1](this,_7f2);
}
_7f1=_7f1||{};
return this.each(function(){
var _7f3=$.data(this,"combo");
if(_7f3){
$.extend(_7f3.options,_7f1);
}else{
var r=init(this);
_7f3=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_7f1),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
_7b2(this);
_7a7(this);
...
var _7f5=$.data(jq[0],"combo").combo.find("input.combo-text");
return _7f5.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_7d5(this);
});
...
$.fn.combo.parseOptions=function(_7f8){
var t=$(_7f8);
return $.extend({},$.fn.validatebox.parseOptions(_7f8),$.parser.parseOptions(_7f8,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),value:(t.val()||undefined)});
};
...
},onChange:function(_7f9,_7fa){
}});
})(jQuery);
(function($){
function _7fb(data,key,_7fc){
for(var i=0;i<data.length;i++){
var item=data[i];
if(item[key]==_7fc){
return item;
...
var _800=$(_7fe).combo("panel");
var item=_800.find("div.combobox-item[value=\""+_7ff+"\"]");
if(item.length){
if(item.position().top<=0){
var h=_800.scrollTop()+item.position().top;
_800.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_800.height()){
var h=_800.scrollTop()+item.position().top+item.outerHeight()-_800.height();
_800.scrollTop(h);
}
}
}
};
function nav(_801,dir){
var opts=$(_801).combobox("options");
var _802=$(_801).combobox("panel");
var item=_802.children("div.combobox-item-hover");
if(!item.length){
item=_802.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
if(!item.length){
item=_802.children("div.combobox-item:visible:"+(dir=="next"?"first":"last"));
}else{
if(dir=="next"){
item=item.nextAll("div.combobox-item:visible:first");
if(!item.length){
item=_802.children("div.combobox-item:visible:first");
}
}else{
item=item.prevAll("div.combobox-item:visible:first");
if(!item.length){
item=_802.children("div.combobox-item:visible:last");
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
_7fd(_801,item.attr("value"));
if(opts.selectOnNavigation){
_803(_801,item.attr("value"));
}
}
};
function _803(_804,_805){
var opts=$.data(_804,"combobox").options;
var data=$.data(_804,"combobox").data;
if(opts.multiple){
var _806=$(_804).combo("getValues");
...
var item=_7fb(data,opts.valueField,_805);
if(item){
opts.onSelect.call(_804,item);
}
};
function _808(_809,_80a){
var _80b=$.data(_809,"combobox");
var opts=_80b.options;
var _80c=$(_809).combo("getValues");
var _80d=_80c.indexOf(_80a+"");
if(_80d>=0){
_80c.splice(_80d,1);
_807(_809,_80c);
}
var item=_7fb(_80b.data,opts.valueField,_80a);
if(item){
opts.onUnselect.call(_809,item);
}
};
function _807(_80e,_80f,_810){
var opts=$.data(_80e,"combobox").options;
var data=$.data(_80e,"combobox").data;
var _811=$(_80e).combo("panel");
_811.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
for(var i=0;i<_80f.length;i++){
var v=_80f[i];
var s=v;
var item=_7fb(data,opts.valueField,v);
if(item){
s=item[opts.textField];
}
vv.push(v);
ss.push(s);
_811.find("div.combobox-item[value=\""+v+"\"]").addClass("combobox-item-selected");
}
$(_80e).combo("setValues",vv);
if(!_810){
$(_80e).combo("setText",ss.join(opts.separator));
}
};
function _812(_813,data,_814){
var _815=$.data(_813,"combobox");
var opts=_815.options;
_815.data=opts.loadFilter.call(_813,data);
data=_815.data;
var _816=$(_813).combobox("getValues");
var dd=[];
var _817=undefined;
for(var i=0;i<data.length;i++){
var item=data[i];
...
dd.push(opts.groupFormatter?opts.groupFormatter.call(_813,g):g);
dd.push("</div>");
}
}else{
_817=undefined;
...
dd.push(opts.formatter?opts.formatter.call(_813,item):s);
dd.push("</div>");
if(item["selected"]){
(function(){
...
$(_813).combo("panel").html(dd.join(""));
if(opts.multiple){
_807(_813,_816,_814);
}else{
if(_816.length){
_807(_813,[_816[_816.length-1]],_814);
}else{
_807(_813,[],_814);
}
}
opts.onLoadSuccess.call(_813,data);
};
function _818(_819,url,_81a,_81b){
var opts=$.data(_819,"combobox").options;
if(url){
opts.url=url;
}
_81a=_81a||{};
if(opts.onBeforeLoad.call(_819,_81a)==false){
return;
}
opts.loader.call(_819,_81a,function(data){
_812(_819,data,_81b);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _81c(_81d,q){
var _81e=$.data(_81d,"combobox");
...
if(opts.mode=="remote"){
_818(_81d,null,{q:q},true);
}else{
var _81f=$(_81d).combo("panel");
_81f.find("div.combobox-item,div.combobox-group").hide();
var data=_81e.data;
var _820=undefined;
for(var i=0;i<data.length;i++){
var item=data[i];
if(opts.filter.call(_81d,q,item)){
var v=item[opts.valueField];
var s=item[opts.textField];
var g=item[opts.groupField];
var item=_81f.find("div.combobox-item[value=\""+v+"\"]");
item.show();
if(s==q){
_807(_81d,[v],true);
item.addClass("combobox-item-selected");
}
if(opts.groupField&&_820!=g){
_81f.find("div.combobox-group[value=\""+g+"\"]").show();
_820=g;
}
}
}
...
function _821(_822){
var t=$(_822);
var _823=t.combobox("panel");
var opts=t.combobox("options");
var data=t.combobox("getData");
var item=_823.children("div.combobox-item-hover");
if(!item.length){
item=_823.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
...
var vv=[];
var _824=t.combobox("getValues");
for(var i=0;i<_824.length;i++){
if(_7fb(data,opts.valueField,_824[i])){
vv.push(_824[i]);
}
}
...
$(_826).addClass("combobox-f");
$(_826).combo($.extend({},opts,{onShowPanel:function(){
$(_826).combo("panel").find("div.combobox-item").show();
_7fd(_826,$(_826).combobox("getValue"));
opts.onShowPanel.call(_826);
}}));
$(_826).combo("panel").unbind().bind("mouseover",function(e){
...
_803(_826,_827);
$(_826).combo("hidePanel");
}
e.stopPropagation();
});
};
$.fn.combobox=function(_828,_829){
if(typeof _828=="string"){
var _82a=$.fn.combobox.methods[_828];
if(_82a){
return _82a(this,_829);
}else{
return this.combo(_828,_829);
}
}
_828=_828||{};
return this.each(function(){
var _82b=$.data(this,"combobox");
if(_82b){
$.extend(_82b.options,_828);
_825(this);
}else{
_82b=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_828),data:[]});
_825(this);
...
_812(this,_82b.options.data);
}
_818(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _82c=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_82c.originalValue,disabled:_82c.disabled,readonly:_82c.readonly});
},getData:function(jq){
...
return jq.each(function(){
$(this).combo("clear");
var _82f=$(this).combo("panel");
_82f.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_830){
return jq.each(function(){
_803(this,_830);
});
},unselect:function(jq,_831){
return jq.each(function(){
_808(this,_831);
});
}};
$.fn.combobox.parseOptions=function(_832){
var t=$(_832);
return $.extend({},$.fn.combo.parseOptions(_832),$.parser.parseOptions(_832,["valueField","textField","groupField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_833){
var data=[];
var opts=$(_833).combobox("options");
$(_833).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _834=$(this).attr("label");
...
item[opts.groupField]=_836;
}
data.push(item);
};
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_837){
return _837;
...
},loader:function(_838,_839,_83a){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_838,dataType:"json",success:function(data){
_839(data);
},error:function(){
_83a.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},onBeforeLoad:function(_83b){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_83c){
},onUnselect:function(_83d){
}});
})(jQuery);
(function($){
function _83e(_83f){
var opts=$.data(_83f,"combotree").options;
var tree=$.data(_83f,"combotree").tree;
$(_83f).addClass("combotree-f");
$(_83f).combo(opts);
var _840=$(_83f).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_840);
$.data(_83f,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _841=$(_83f).combotree("getValues");
if(opts.multiple){
...
$(_83f).combotree("setValues",_841);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_844(_83f);
$(_83f).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_843){
_844(_83f);
opts.onCheck.call(this,node,_843);
}}));
};
function _844(_845){
var opts=$.data(_845,"combotree").options;
var tree=$.data(_845,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _846=tree.tree("getChecked");
...
$(_845).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
...
$(_848).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_84a,_84b){
if(typeof _84a=="string"){
var _84c=$.fn.combotree.methods[_84a];
if(_84c){
return _84c(this,_84b);
}else{
return this.combo(_84a,_84b);
}
}
_84a=_84a||{};
return this.each(function(){
var _84d=$.data(this,"combotree");
if(_84d){
$.extend(_84d.options,_84a);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_84a)});
}
_83e(this);
});
};
...
return $.extend($.data(jq[0],"combotree").options,{originalValue:_84e.originalValue,disabled:_84e.disabled,readonly:_84e.readonly});
},tree:function(jq){
...
$.fn.combotree.parseOptions=function(_851){
return $.extend({},$.fn.combo.parseOptions(_851),$.fn.tree.parseOptions(_851));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _852(_853){
var _854=$.data(_853,"combogrid");
var opts=_854.options;
var grid=_854.grid;
$(_853).addClass("combogrid-f").combo(opts);
var _855=$(_853).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_855);
_854.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _856=$(_853).combo("getValues");
var _857=opts.onSelect;
opts.onSelect=function(){
};
_861(_853,_856,_854.remainText);
opts.onSelect=_857;
opts.onLoadSuccess.apply(_853,arguments);
},onClickRow:_858,onSelect:function(_859,row){
_85a();
opts.onSelect.call(this,_859,row);
},onUnselect:function(_85b,row){
_85a();
opts.onUnselect.call(this,_85b,row);
},onSelectAll:function(rows){
_85a();
...
function _858(_85c,row){
_854.remainText=false;
_85a();
if(!opts.multiple){
$(_853).combo("hidePanel");
}
opts.onClickRow.call(this,_85c,row);
};
function _85a(){
...
if(!opts.multiple){
$(_853).combo("setValues",(vv.length?vv:[""]));
}else{
$(_853).combo("setValues",vv);
}
if(!_854.remainText){
$(_853).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_85d,dir){
var _85e=$.data(_85d,"combogrid");
var opts=_85e.options;
var grid=_85e.grid;
var _85f=grid.datagrid("getRows").length;
if(!_85f){
return;
}
...
var _860;
if(!tr.length){
_860=(dir=="next"?0:_85f-1);
}else{
var _860=parseInt(tr.attr("datagrid-row-index"));
_860+=(dir=="next"?1:-1);
if(_860<0){
_860=_85f-1;
}
...
grid.datagrid("highlightRow",_860);
if(opts.selectOnNavigation){
_85e.remainText=false;
grid.datagrid("selectRow",_860);
}
};
function _861(_862,_863,_864){
var _865=$.data(_862,"combogrid");
var opts=_865.options;
var grid=_865.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _866=$(_862).combo("getValues");
var _867=$(_862).combo("options");
var _868=_867.onChange;
_867.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_863.length;i++){
var _869=grid.datagrid("getRowIndex",_863[i]);
if(_869>=0){
grid.datagrid("selectRow",_869);
ss.push(rows[_869][opts.textField]);
}else{
ss.push(_863[i]);
}
}
$(_862).combo("setValues",_866);
_867.onChange=_868;
$(_862).combo("setValues",_863);
if(!_864){
var s=ss.join(opts.separator);
if($(_862).combo("getText")!=s){
$(_862).combo("setText",s);
}
}
};
function _86a(_86b,q){
var _86c=$.data(_86b,"combogrid");
var opts=_86c.options;
var grid=_86c.grid;
_86c.remainText=true;
if(opts.multiple&&!q){
_861(_86b,[],true);
}else{
_861(_86b,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_86b,q,rows[i])){
grid.datagrid("clearSelections");
...
_86f.remainText=false;
var _870=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_870);
}else{
grid.datagrid("selectRow",_870);
}
}else{
grid.datagrid("selectRow",_870);
$(_86e).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_871,_872){
if(typeof _871=="string"){
var _873=$.fn.combogrid.methods[_871];
if(_873){
return _873(this,_872);
}else{
return $.fn.combo.methods[_871](this,_872);
}
}
_871=_871||{};
return this.each(function(){
var _874=$.data(this,"combogrid");
if(_874){
$.extend(_874.options,_871);
}else{
_874=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_871)});
}
_852(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _875=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{originalValue:_875.originalValue,disabled:_875.disabled,readonly:_875.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_876){
return jq.each(function(){
_861(this,_876);
});
...
$.fn.combogrid.parseOptions=function(_878){
var t=$(_878);
return $.extend({},$.fn.combo.parseOptions(_878),$.fn.datagrid.parseOptions(_878),$.parser.parseOptions(_878,["idField","textField","mode"]));
};
...
(function($){
function _879(_87a){
var _87b=$.data(_87a,"datebox");
var opts=_87b.options;
$(_87a).addClass("datebox-f");
$(_87a).combo($.extend({},opts,{onShowPanel:function(){
_87b.calendar.calendar("resize");
opts.onShowPanel.call(_87a);
}}));
$(_87a).combo("textbox").parent().addClass("datebox");
if(!_87b.calendar){
_87c();
}
function _87c(){
var _87d=$(_87a).combo("panel");
_87b.calendar=$("<div></div>").appendTo(_87d).wrap("<div class=\"datebox-calendar-inner\"></div>");
_87b.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _87e=opts.formatter(date);
_882(_87a,_87e);
$(_87a).combo("hidePanel");
opts.onSelect.call(_87a,date);
}});
_882(_87a,opts.value);
var _87f=$("<div class=\"datebox-button\"></div>").appendTo(_87d);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_87f);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_87f);
_87f.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_87f.find(".datebox-current").click(function(){
_87b.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_87f.find(".datebox-close").click(function(){
$(_87a).combo("hidePanel");
});
};
};
function _880(_881,q){
_882(_881,q);
};
function _883(_884){
var opts=$.data(_884,"datebox").options;
var c=$.data(_884,"datebox").calendar;
var _885=opts.formatter(c.calendar("options").current);
_882(_884,_885);
$(_884).combo("hidePanel");
};
function _882(_886,_887){
var _888=$.data(_886,"datebox");
var opts=_888.options;
$(_886).combo("setValue",_887).combo("setText",_887);
_888.calendar.calendar("moveTo",opts.parser(_887));
};
$.fn.datebox=function(_889,_88a){
if(typeof _889=="string"){
var _88b=$.fn.datebox.methods[_889];
if(_88b){
...
_889=_889||{};
return this.each(function(){
var _88c=$.data(this,"datebox");
if(_88c){
$.extend(_88c.options,_889);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_889)});
}
_879(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{originalValue:_88d.originalValue,disabled:_88d.disabled,readonly:_88d.readonly});
...
$.fn.datebox.parseOptions=function(_88f){
var t=$(_88f);
return $.extend({},$.fn.combo.parseOptions(_88f),{});
};
...
(function($){
function _890(_891){
var _892=$.data(_891,"datetimebox");
var opts=_892.options;
$(_891).datebox($.extend({},opts,{onShowPanel:function(){
var _893=$(_891).datetimebox("getValue");
_896(_891,_893,true);
opts.onShowPanel.call(_891);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_891).removeClass("datebox-f").addClass("datetimebox-f");
$(_891).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_891,date);
}});
var _894=$(_891).datebox("panel");
if(!_892.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_894.children("div.datebox-calendar-inner"));
_892.spinner=p.children("input");
var _895=_894.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_895);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
_892.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_896(_891,opts.value);
};
function _897(_898){
var c=$(_898).datetimebox("calendar");
var t=$(_898).datetimebox("spinner");
...
function _89b(_89c){
var opts=$.data(_89c,"datetimebox").options;
var date=_897(_89c);
_896(_89c,opts.formatter.call(_89c,date));
$(_89c).combo("hidePanel");
};
function _896(_89d,_89e,_89f){
var opts=$.data(_89d,"datetimebox").options;
$(_89d).combo("setValue",_89e);
if(!_89f){
if(_89e){
var date=opts.parser.call(_89d,_89e);
$(_89d).combo("setValue",opts.formatter.call(_89d,date));
$(_89d).combo("setText",opts.formatter.call(_89d,date));
}else{
$(_89d).combo("setText",_89e);
}
}
var date=opts.parser.call(_89d,_89e);
$(_89d).datetimebox("calendar").calendar("moveTo",date);
$(_89d).datetimebox("spinner").timespinner("setValue",_8a0(date));
function _8a0(date){
function _8a1(_8a2){
return (_8a2<10?"0":"")+_8a2;
};
var tt=[_8a1(date.getHours()),_8a1(date.getMinutes())];
if(opts.showSeconds){
tt.push(_8a1(date.getSeconds()));
}
return tt.join($(_89d).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_8a3,_8a4){
if(typeof _8a3=="string"){
var _8a5=$.fn.datetimebox.methods[_8a3];
if(_8a5){
return _8a5(this,_8a4);
}else{
return this.datebox(_8a3,_8a4);
}
}
_8a3=_8a3||{};
return this.each(function(){
var _8a6=$.data(this,"datetimebox");
if(_8a6){
$.extend(_8a6.options,_8a3);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_8a3)});
}
_890(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _8a7=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_8a7.originalValue,disabled:_8a7.disabled,readonly:_8a7.readonly});
},spinner:function(jq){
...
$.fn.datetimebox.parseOptions=function(_8a9){
var t=$(_8a9);
return $.extend({},$.fn.datebox.parseOptions(_8a9),$.parser.parseOptions(_8a9,["timeSeparator",{showSeconds:"boolean"}]));
};
...
function _8aa(_8ab){
return (_8ab<10?"0":"")+_8ab;
};
var _8ac=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_8aa(h)+_8ac+_8aa(M);
...
var _8ad=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_8ad);
var hour=parseInt(tt[0],10)||0;
var _8ae=parseInt(tt[1],10)||0;
var _8af=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_8ae,_8af);
}});
})(jQuery);
(function($){
function init(_8b0){
var _8b1=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_8b0);
var name=$(_8b0).hide().attr("name");
if(name){
_8b1.find("input.slider-value").attr("name",name);
$(_8b0).removeAttr("name").attr("sliderName",name);
}
return _8b1;
};
...
if(_8b4){
if(_8b4.width){
opts.width=_8b4.width;
}
if(_8b4.height){
opts.height=_8b4.height;
}
}
if(opts.mode=="h"){
_8b6.css("height","");
_8b6.children("div").css("height","");
if(!isNaN(opts.width)){
_8b6.width(opts.width);
}
}else{
_8b6.css("width","");
_8b6.children("div").css("width","");
if(!isNaN(opts.height)){
_8b6.height(opts.height);
_8b6.find("div.slider-rule").height(opts.height);
_8b6.find("div.slider-rulelabel").height(opts.height);
_8b6.find("div.slider-inner")._outerHeight(opts.height);
}
}
_8b7(_8b3);
};
function _8b8(_8b9){
var _8ba=$.data(_8b9,"slider");
var opts=_8ba.options;
var _8bb=_8ba.slider;
...
_8bc(aa);
function _8bc(aa){
var rule=_8bb.find("div.slider-rule");
var _8bd=_8bb.find("div.slider-rulelabel");
rule.empty();
_8bd.empty();
for(var i=0;i<aa.length;i++){
var _8be=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_8be);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_8bd);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_8be,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_8be,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _8bf(_8c0){
var _8c1=$.data(_8c0,"slider");
var opts=_8c1.options;
var _8c2=_8c1.slider;
_8c2.removeClass("slider-h slider-v slider-disabled");
_8c2.addClass(opts.mode=="h"?"slider-h":"slider-v");
_8c2.addClass(opts.disabled?"slider-disabled":"");
_8c2.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _8c4=_8d5(_8c0,left);
_8c5(_8c4);
return false;
}
},onStartDrag:function(){
opts.onSlideStart.call(_8c0,opts.value);
},onStopDrag:function(e){
var _8c6=_8d5(_8c0,(opts.mode=="h"?e.data.left:e.data.top));
_8c5(_8c6);
opts.onSlideEnd.call(_8c0,opts.value);
}});
function _8c5(_8c7){
var s=Math.abs(_8c7%opts.step);
if(s<opts.step/2){
_8c7-=s;
}else{
_8c7=_8c7-s+opts.step;
}
_8c8(_8c0,_8c7);
};
};
function _8c8(_8c9,_8ca){
var _8cb=$.data(_8c9,"slider");
var opts=_8cb.options;
var _8cc=_8cb.slider;
var _8cd=opts.value;
if(_8ca<opts.min){
_8ca=opts.min;
}
...
opts.value=_8ca;
$(_8c9).val(_8ca);
_8cc.find("input.slider-value").val(_8ca);
var pos=_8ce(_8c9,_8ca);
var tip=_8cc.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_8c9,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _8cf="left:"+pos+"px;";
_8cc.find(".slider-handle").attr("style",_8cf);
tip.attr("style",_8cf+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _8cf="top:"+pos+"px;";
_8cc.find(".slider-handle").attr("style",_8cf);
tip.attr("style",_8cf+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_8cd!=_8ca){
...
function _8b7(_8d0){
var opts=$.data(_8d0,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_8c8(_8d0,opts.value);
opts.onChange=fn;
};
function _8ce(_8d1,_8d2){
var _8d3=$.data(_8d1,"slider");
var opts=_8d3.options;
var _8d4=_8d3.slider;
if(opts.mode=="h"){
var pos=(_8d2-opts.min)/(opts.max-opts.min)*_8d4.width();
if(opts.reversed){
pos=_8d4.width()-pos;
}
}else{
var pos=_8d4.height()-(_8d2-opts.min)/(opts.max-opts.min)*_8d4.height();
if(opts.reversed){
pos=_8d4.height()-pos;
}
}
...
function _8d5(_8d6,pos){
var _8d7=$.data(_8d6,"slider");
var opts=_8d7.options;
var _8d8=_8d7.slider;
if(opts.mode=="h"){
var _8d9=opts.min+(opts.max-opts.min)*(pos/_8d8.width());
}else{
var _8d9=opts.min+(opts.max-opts.min)*((_8d8.height()-pos)/_8d8.height());
}
return opts.reversed?opts.max-_8d9.toFixed(0):_8d9.toFixed(0);
};
$.fn.slider=function(_8da,_8db){
if(typeof _8da=="string"){
return $.fn.slider.methods[_8da](this,_8db);
}
_8da=_8da||{};
return this.each(function(){
var _8dc=$.data(this,"slider");
if(_8dc){
$.extend(_8dc.options,_8da);
}else{
_8dc=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_8da),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_8df){
var t=$(_8df);
return $.extend({},$.parser.parseOptions(_8df,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_8e0){
return _8e0;
},onChange:function(_8e1,_8e2){
},onSlideStart:function(_8e3){
},onSlideEnd:function(_8e4){
}};
})(jQuery);
