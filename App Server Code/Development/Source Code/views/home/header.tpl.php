...
<head>
    ...
    <link href="<?php echo $config['LIVE_URL']; ?>views/font-awesome/css/font-awesome.css" rel="stylesheet">
	 ...
	 <link rel="stylesheet" href="<?php echo $config['LIVE_URL']; ?>views/js/bootstrap-fileupload/bootstrap-fileupload.css" />
	...
	-->
	<link href="<?php echo $config['LIVE_URL']; ?>views/css/facebox.css" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $config['LIVE_URL']; ?>views/js/bootstrap-colorpicker/css/colorpicker.css" />
	
	<link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css">
     <!--<link href="<?php echo $config['LIVE_URL']; ?>views/css/lightbox-form.css" rel="stylesheet">-->
	...
	<!--Core js-->
	<link rel="stylesheet" href="<?php echo $config['LIVE_URL'];?>plugins/jquery-date-range-picker-master/daterangepicker.css" />
	<style>
		#wrapper
		{
			width:800px;
...
<!--<script src="<?php echo $config['LIVE_URL']; ?>views/js/jquery-1.4.2.js"></script>
<script src="<?php echo $config['LIVE_URL']; ?>views/js/jquery-1.8.2.js"></script>
-->
