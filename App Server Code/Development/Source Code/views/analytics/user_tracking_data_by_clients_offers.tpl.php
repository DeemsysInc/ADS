<div id="control-bar" class="grey-bg clearfix" style="opacity: 1;"><div class="container_12">
        ...
        <div style="float:left; padding-top: 6px;text-align: center;width: 75%;"><h1 id="client_name">User tracking </h1></div>
...
<?php 
  ...
  if(isset($params['search_client_id']) && $params['search_client_id']!=0)
  {
    $clientInfo = "?cid=".$params['search_client_id']; 
  ...
  ?>			
<div align="right">
	<form  id="table_form" method="post" action="<?php echo $config['LIVE_URL']; ?>analytics/mobile_users/client_offers/<?php echo $clientInfo;?>">
	...
	<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
		...
		<table class="table sortable no-margin" cellspacing="0" width="100%" id="cms_clients">
			...
			<tbody>
				...
				<tr style="cursor:pointer;" onclick="document.location = '<?php echo $config['LIVE_URL'];?>analytics/mobile_users/clients/<?php echo isset($arrData[$i]['client_id']) ? $arrData[$i]['client_id'] : ''; ?>/offers/<?php echo $start_date;?>/<?php echo $end_date;?>';">
					...
					<td><?php echo isset($arrData[$i]['no_of_offers']) ? $arrData[$i]['no_of_offers'] : ''; ?></td>
