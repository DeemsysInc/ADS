...
$server_type=2;//1=localhost ,2= beta ,3 =live,4=mac localhost
...
$config['LIVE_URL'] = 'http://'.$_SERVER['HTTP_HOST'].'/oursadda/';
...
$config['ANALYTICS_WS_LIVE_URL'] = 'http://devanalyticsws.seemoreinteractive.com/';
...
$config['LIVE_URL'] = 'http://'.$_SERVER['HTTP_HOST'].'/devarapps/';
...
$config['files']['all_clients_markers'] = $config['LIVE_URL'].'files/all_clients_markers/';
...
$config['root_files']['all_clients_markers'] = SRV_ROOT.'files/all_clients_markers/';
...
$config['trash_files']['all_clients_markers'] = SRV_ROOT.'files/trash/all_clients_markers/';
