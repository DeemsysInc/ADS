	...
	public function pageContent($pUrl){
		try{
			...
			if (isset($arrCondi[0]) && ($arrCondi[0]=='json'))
			{
				...
				$arrsample['lat_long']=isset($_REQUEST['lat_long']) ? $_REQUEST['lat_long'] : '';
				...
				$arrsample['device_bundle_version']=isset($_REQUEST['device_bundle_version']) ? $_REQUEST['device_bundle_version'] : '';
