<div id="control-bar" class="grey-bg clearfix" style="opacity: 1;"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onclick="location.href='<?php echo $config['LIVE_URL']; ?>clients/add'">Add Client group</button> 
		</div>
		...
		<table class="table sortable no-margin" cellspacing="0" width="100%" id="cms_clients">
			...
			<tbody>
				...
				<tr>
					...
					<td style="background:#CCC;border-bottom: 1px solid #fff;"><a href="#"><?php echo $dispClient; ?></a></td>
					...
					<td>
	                    ...
	                    <button type="button" class="blue" >Delete</button>
	                </td>
                </tr>
				<?php } }?>
			</tbody>
