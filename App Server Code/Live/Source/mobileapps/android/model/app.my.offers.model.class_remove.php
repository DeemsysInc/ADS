...
class mMyOffers extends SQLQuery {
...

	{
		...
		$query = "SELECT cl.id, cl.name,cl.client_vertical_id, mof.my_offers_name, mof.user_id, mofr.my_offers_ref_id, of.offer_id, of.client_id, cl.background_color, cl.light_color, cl.dark_color, 
