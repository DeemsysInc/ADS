...
$config['database']['name'] = 'arapps_cms';
$config['database']['host'] = 'localhost';
$config['database']['user'] = 'arapps_dbuser';
$config['database']['password'] = 'Ar@ppsDpUs@r@2014';

$config['database']['masterdb'] = 'arapps_master';
...
// $config['stream_mediapath'] = "http://198.12.157.225:5080/seemore/dev/";
...
// $config['files']['logo'] = $config['stream_mediapath'].'files/clients/{client_id}/logo/';
// $config['files']['background'] = $config['stream_mediapath'].'files/clients/{client_id}/background/';
// $config['files']['triggers'] = $config['stream_mediapath'].'files/clients/{client_id}/triggers/';
// $config['files']['products'] = $config['stream_mediapath'].'files/clients/{client_id}/products/';
// $config['files']['additional']=$config['stream_mediapath'].'files/clients/{client_id}/additional/';
// $config['files']['videos']=$config['stream_mediapath'].'files/clients/{client_id}/videos/';
// $config['files']['models']=$config['stream_mediapath'].'files/clients/{client_id}/models/';

// $config['files']['videostreaming']='rtmp://198.12.157.225:1935/vod/';
