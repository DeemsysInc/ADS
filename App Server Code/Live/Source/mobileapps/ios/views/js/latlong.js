...
function displayLT(c){
      ...
      var bothCords = c[0].geometry.location;
      ...
      //  strLng += " E"
      // }
      var objC = strLat + "," + strLng;
      $('#putLatLng').text(objC);
      document.write('jhello');
      // $('div#putLatLng').fadeIn();
}
// function showMap(c)
// {
//  var myOptions = {
...
//  $('.printlink').addClass('noshow');
//  var map = new google.maps.Map(document.getElementById("map_canvas"), myOptions);
//  var marker = new google.maps.Marker({position: c[0].geometry.location, map: map, title: c[0].formatted_address});
// }