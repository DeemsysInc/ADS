...
<div align="right">
	<form  id="table_form" method="post" action="<?php echo $config['LIVE_URL']; ?>analytics/mobile_users/clients/<?php echo isset($arrData[0]['client_id']) ? $arrData[0]['client_id'] : '';?>/offers/">
	...
	<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
		...
		<table class="table sortable no-margin" cellspacing="0" width="100%" id="cms_clients">
			...
			<tbody>
				...
				?>
				<tr onclick="document.location = '<?php echo $config['LIVE_URL'];?>analytics/mobile_users/offers/flow/<?php echo isset($arrData[$i]['offer_id']) ? $arrData[$i]['offer_id'] : ''; ?>/<?php echo $start_date;?>/<?php echo $end_date;?>';">
					...
					<td><?php echo isset($arrData[$i]['offer_exp_date']) ? $arrData[$i]['offer_exp_date'] : '0'; ?></td>
					<td><?php echo isset($arrData[$i]['offer_views']) ? $arrData[$i]['offer_views'] : '0'; ?></td>
					<td><?php echo isset($arrData[$i]['myoffers']) ? $arrData[$i]['myoffers'] : '0'; ?></td>
