...
<div align="right">
	<form  id="table_form" method="post" action="<?php echo $config['LIVE_URL']; ?>analytics/mobile_users/product_views/clients">
	...
	<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
		...
		<table class="table sortable no-margin" cellspacing="0" width="100%" id="cms_clients">
			...
			<tbody>
				...
				<tr style="cursor: pointer; cursor: hand;" onclick="document.location = '<?php echo $config['LIVE_URL'];?>analytics/mobile_users/product_views/clients/date/<?php echo isset($arrData[$i]['client_id']) ? $arrData[$i]['client_id'] : ''; ?>/<?php echo $start_date;?>';">
