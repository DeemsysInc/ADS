	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: root_url+'views/images/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: root_url+'views/images/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
