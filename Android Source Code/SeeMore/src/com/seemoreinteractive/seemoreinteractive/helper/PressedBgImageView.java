 ...
 * @author shiki
 */
public class PressedBgImageView extends ImageView {

  public PressedBgImageView(Context context) {
    super(context);
  }

  public PressedBgImageView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public PressedBgImageView(Context context, AttributeSet attrs, int defStyle) {
