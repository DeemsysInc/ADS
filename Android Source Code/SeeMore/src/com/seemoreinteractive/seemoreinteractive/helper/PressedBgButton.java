 ...
 * @author shiki
 */
public class PressedBgButton extends Button {

  public PressedBgButton(Context context) {
    super(context);
  }

  public PressedBgButton(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public PressedBgButton(Context context, AttributeSet attrs, int defStyle) {
