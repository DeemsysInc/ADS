 ...
 * @author shiki
 */
public class PressedBgLinearLayout extends LinearLayout {

  public PressedBgLinearLayout(Context context) {
    super(context);
  }

  public PressedBgLinearLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public PressedBgLinearLayout(Context context, AttributeSet attrs, int defStyle) {
