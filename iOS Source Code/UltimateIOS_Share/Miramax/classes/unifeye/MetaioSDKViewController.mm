...
#define SDK_LICENSE "qG1SMGY6KIVcfjh3JOQO7KaYsOeF+zHd6caAyRuCo0c="
...
- (void) viewDidLoad
{
    ...
    CGSize screenGlViewSize = screenBound.size;
    CGFloat screenWidth = screenGlViewSize.width;
    CGFloat screenHeight = screenGlViewSize.height;
    if (screenHeight==568){
