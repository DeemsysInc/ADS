...
public:
	 ...
	 */
	virtual void onAnimationEnd(metaio::IGeometry* geometry, std::string animationName) {};
	 ...
	 * \return void
	 */
	virtual void onMovieEnd(metaio::IGeometry* geometry, std::string movieName) {};
	 ...
	 *
	 */
	virtual void onCameraImageSaved(const std::string& filepath) {};
	 ...
	 * \sa IMetaioSDK::requestScreenshot
	 */
	virtual void onScreenshot(const std::string& filepath) {};
	...
	*
	*/
	virtual void onTrackingEvent(std::vector< metaio::TrackingValues > trackingValues) {};
	...
	*/
	virtual void onInstantTrackingEvent(bool success, const std::string& file) {};
