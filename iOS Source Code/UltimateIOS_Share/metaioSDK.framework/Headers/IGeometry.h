...
public:
	 ...
	 */
	virtual void startAnimation(const std::string& animationName = std::string(""), bool loop = false) = 0;
	 ...
	 */
	virtual bool setTexture(const std::string& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setTexture(const std::string& textureName, const ImageStruct& image, const bool updateable = false) = 0;
	 ...
	 */
	virtual bool setMovieTexture(const std::string& filename,
