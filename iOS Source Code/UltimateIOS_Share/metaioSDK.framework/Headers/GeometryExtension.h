...
class GeometryExtension {
    ...
    float m_referenceOffsetX;
    float m_referenceOffsetY;
    float m_referenceOffsetZ;
...
public:
     ...
     * \param pickable Specify if the geometry can be selected.
     * \param group Specity the group number of the geometry.
     */
    GeometryExtension(metaio::IGeometry* geometry, bool pickable, int group);
