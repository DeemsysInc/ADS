...
public:
	 ...
	 */
	virtual bool setBackgroundTexture(const std::string& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setBackgroundTexture(const std::string& textureName, const ImageStruct& image,
	 ...
	 * \return true on success
	 */
	virtual bool setObjectsDefaultTexture(const std::string& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setObjectsDefaultTexture(const std::string& textureName, const ImageStruct& image,
	                                      const bool updateable = false) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setObjectTexture(IGeometry* geometry, const std::string& texturePath) = 0;
	 ...
	 * \return true on success
	 */
	virtual bool setObjectTexture(IGeometry* geometry, const std::string& textureName,
