...
-(void)sendMail
{
    ...
    if (mailClass != nil && [mailClass canSendMail]) {
            ...
            picker.subject = [[NSString alloc] initWithFormat:@"My Miramax Snapshot – Celebrating 20 years of Tarantino Filmmaking"];
            ...
            [picker addAttachmentData:imageData mimeType:@"image/jpg" fileName:@"Miramax.jpg"];
            
            // Fill out the email body text.
            NSString *emailBody = [[NSString alloc] initWithFormat:@"Here I am, stuck in the middle with you…<br><br>Reservoir Dogs and Pulp Fiction Back in Theaters Dec 4 & Dec 6.  Get tickets: http://www.TarantinoXX.com/<br><br>Get the app for Apple http://bit.ly/SyDGrb or Android http://bit.ly/TOTt8I"];
...
- (IBAction)postToTwitter {
    if ([TWTweetComposeViewController canSendTweet]) {
        ...
        NSString *message = [[NSString alloc] initWithFormat:@".@Miramax"];
