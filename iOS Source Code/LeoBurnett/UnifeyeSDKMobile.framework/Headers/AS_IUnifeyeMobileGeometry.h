...
namespace metaio
{
		...
		public:
			...
			*
			* \param rotation The rotation vector in Euler angles representation, where the Euler angles
			...
			*/
			...
			/** 
			* \brief Determine if the 3D model is currently being rendered (object is inside view frustum, not set to invisible, tracking works, .
			...
			*/
			...
			/**
			* \brief Set the animation speed of the model.
			* \param pauseOrUnpause Pause or unpause the models currently played animation
			*/
			virtual void pauseAnimation( bool pauseOrUnpause ) = 0;

			/**
			* \brief Returns all possible animation names.
			* \return all aniamtion names.
			* \sa startAnimation
			*/
			...
			/**
			 * \brief Set a name of the geometry
			...
			/**
			 * \brief Get the name of the geometry previously set
